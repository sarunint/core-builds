 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function makeDecorator(name,props,parentClass,additionalProcessing,typeFn){var metaCtor=makeMetadataCtor(props);function DecoratorFactory(){for(var _a,args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(this instanceof DecoratorFactory)return metaCtor.call.apply(metaCtor,[this].concat(args)),this;var annotationInstance=new((_a=DecoratorFactory).bind.apply(_a,[void 0].concat(args)));return function(cls){return typeFn&&typeFn.apply(void 0,[cls].concat(args)),(cls.hasOwnProperty(ANNOTATIONS)?cls[ANNOTATIONS]:Object.defineProperty(cls,ANNOTATIONS,{value:[]})[ANNOTATIONS]).push(annotationInstance),additionalProcessing&&additionalProcessing(cls),cls}}return parentClass&&(DecoratorFactory.prototype=Object.create(parentClass.prototype)),DecoratorFactory.prototype.ngMetadataName=name,DecoratorFactory.annotationCls=DecoratorFactory,DecoratorFactory}function makeMetadataCtor(props){return function(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(props){var values=props.apply(void 0,args);for(var propName in values)this[propName]=values[propName]}}}function makeParamDecorator(name,props,parentClass){var metaCtor=makeMetadataCtor(props);function ParamDecoratorFactory(){for(var _a,args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(this instanceof ParamDecoratorFactory)return metaCtor.apply(this,args),this;var annotationInstance=new((_a=ParamDecoratorFactory).bind.apply(_a,[void 0].concat(args)));return ParamDecorator.annotation=annotationInstance,ParamDecorator;function ParamDecorator(cls,unusedKey,index){for(var parameters=cls.hasOwnProperty(PARAMETERS)?cls[PARAMETERS]:Object.defineProperty(cls,PARAMETERS,{value:[]})[PARAMETERS];parameters.length<=index;)parameters.push(null);return(parameters[index]=parameters[index]||[]).push(annotationInstance),cls}}return parentClass&&(ParamDecoratorFactory.prototype=Object.create(parentClass.prototype)),ParamDecoratorFactory.prototype.ngMetadataName=name,ParamDecoratorFactory.annotationCls=ParamDecoratorFactory,ParamDecoratorFactory}function makePropDecorator(name,props,parentClass,additionalProcessing){var metaCtor=makeMetadataCtor(props);function PropDecoratorFactory(){for(var _a,args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i];if(this instanceof PropDecoratorFactory)return metaCtor.apply(this,args),this;var decoratorInstance=new((_a=PropDecoratorFactory).bind.apply(_a,[void 0].concat(args)));return function(target,name){var constructor=target.constructor,meta=constructor.hasOwnProperty(PROP_METADATA)?constructor[PROP_METADATA]:Object.defineProperty(constructor,PROP_METADATA,{value:{}})[PROP_METADATA];meta[name]=meta.hasOwnProperty(name)&&meta[name]||[],meta[name].unshift(decoratorInstance),additionalProcessing&&additionalProcessing.apply(void 0,[target,name].concat(args))}}return parentClass&&(PropDecoratorFactory.prototype=Object.create(parentClass.prototype)),PropDecoratorFactory.prototype.ngMetadataName=name,PropDecoratorFactory.annotationCls=PropDecoratorFactory,PropDecoratorFactory}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var ViewEncapsulation={Emulated:0,Native:1,None:2,ShadowDom:3};ViewEncapsulation[ViewEncapsulation.Emulated]="Emulated",ViewEncapsulation[ViewEncapsulation.Native]="Native",ViewEncapsulation[ViewEncapsulation.None]="None",ViewEncapsulation[ViewEncapsulation.ShadowDom]="ShadowDom";
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var _injectImplementation,Inject=makeParamDecorator("Inject",function(token){return{token:token}}),Optional=makeParamDecorator("Optional"),Self=makeParamDecorator("Self"),SkipSelf=makeParamDecorator("SkipSelf"),Host=makeParamDecorator("Host"),_currentInjector=void 0;function setCurrentInjector(injector){var former=_currentInjector;return _currentInjector=injector,former}function setInjectImplementation(impl){var previous=_injectImplementation;return _injectImplementation=impl,previous}function injectInjectorOnly(token,flags){if(void 0===flags&&(flags=0),void 0===_currentInjector)throw new Error("inject() must be called from an injection context");return null===_currentInjector?injectRootLimpMode(token,void 0,flags):_currentInjector.get(token,8&flags?null:void 0,flags)}function inject(token,flags){return void 0===flags&&(flags=0),(_injectImplementation||injectInjectorOnly)(token,flags)}function injectRootLimpMode(token,notFoundValue,flags){var injectableDef=getInjectableDef(token);if(injectableDef&&"root"==injectableDef.providedIn)return void 0===injectableDef.value?injectableDef.value=injectableDef.factory():injectableDef.value;if(8&flags)return null;if(void 0!==notFoundValue)return notFoundValue;throw new Error("Injector: NOT_FOUND ["+stringify(token)+"]")}function injectArgs(types){for(var args=[],i=0;i<types.length;i++){var arg=types[i];if(Array.isArray(arg)){if(0===arg.length)throw new Error("Arguments array must have arguments.");for(var type=void 0,flags=0,j=0;j<arg.length;j++){var meta=arg[j];meta instanceof Optional||"Optional"===meta.ngMetadataName?flags|=8:meta instanceof SkipSelf||"SkipSelf"===meta.ngMetadataName?flags|=4:meta instanceof Self||"Self"===meta.ngMetadataName?flags|=2:type=meta instanceof Inject?meta.token:meta}args.push(inject(type,flags))}else args.push(inject(arg))}return args}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function assertEqual(actual,expected,msg){actual!=expected&&throwError(msg)}function assertNotEqual(actual,expected,msg){actual==expected&&throwError(msg)}function assertLessThan(actual,expected,msg){actual>=expected&&throwError(msg)}function assertDefined(actual,msg){null==actual&&throwError(msg)}function assertComponentType(actual,msg){void 0===msg&&(msg="Type passed in is not ComponentType, it does not have 'ngComponentDef' property."),getComponentDef(actual)||throwError(msg)}function throwError(msg){throw new Error("ASSERTION ERROR: "+msg)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var MONKEY_PATCH_KEY_NAME="__ngContext__",HEADER_OFFSET=17,TVIEW=0,FLAGS=1,PARENT=2,NEXT=3,QUERIES=4,HOST=5,HOST_NODE=6,BINDING_INDEX=7,CLEANUP=8,CONTEXT=9,INJECTOR=10,RENDERER=11,SANITIZER=12,TAIL=13,CONTAINER_INDEX=14,CONTENT_QUERIES=15,DECLARATION_VIEW=16;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var ACTIVE_INDEX=0,VIEWS=1,NATIVE=6,RENDER_PARENT=7,TNODE=8,PARENT_INJECTOR=8,INJECTOR_SIZE=9,NO_PARENT_INJECTOR=-1,NodeInjectorFactory=function(){return function(factory,isViewProvider,injectImplementation){this.factory=factory,this.resolving=!1,this.canSeeViewProviders=isViewProvider,this.injectImpl=injectImplementation}}(),FactoryPrototype=NodeInjectorFactory.prototype;function stringify$1(value){return"function"==typeof value?value.name||value:"string"==typeof value?value:null==value?"":""+value}function loadInternal(index,arr){return ngDevMode&&assertDataInRangeInternal(index+HEADER_OFFSET,arr),arr[index+HEADER_OFFSET]}function assertDataInRangeInternal(index,arr){assertLessThan(index,arr?arr.length:0,"index expected to be a valid data index")}function readElementValue(value){for(;Array.isArray(value);)value=value[HOST];return value}function getNativeByIndex(index,arr){return readElementValue(arr[index+HEADER_OFFSET])}function getNativeByTNode(tNode,hostView){return readElementValue(hostView[tNode.index])}function getTNode(index,view){return view[TVIEW].data[index+HEADER_OFFSET]}function getComponentViewByIndex(nodeIndex,hostView){var slotValue=hostView[nodeIndex];return slotValue.length>=HEADER_OFFSET?slotValue:slotValue[HOST]}function isContentQueryHost(tNode){return 0!=(16384&tNode.flags)}function isComponent(tNode){return 4096==(4096&tNode.flags)}function isComponentDef(def){return null!==def.template}function isLContainer(value){return Array.isArray(value)&&"number"==typeof value[ACTIVE_INDEX]}function isRootView(target){return 0!=(64&target[FLAGS])}function getRootView(target){ngDevMode&&assertDefined(target,"component");for(var lViewData=Array.isArray(target)?target:readPatchedLViewData(target);lViewData&&!(64&lViewData[FLAGS]);)lViewData=lViewData[PARENT];return lViewData}function getRootContext$1(viewOrComponent){var rootView=getRootView(viewOrComponent);return ngDevMode&&assertDefined(rootView[CONTEXT],"RootView has no context. Perhaps it is disconnected?"),rootView[CONTEXT]}function readPatchedData(target){return target[MONKEY_PATCH_KEY_NAME]}function readPatchedLViewData(target){var value=readPatchedData(target);return value?Array.isArray(value)?value:value.lViewData:null}function hasParentInjector(parentLocation){return parentLocation!==NO_PARENT_INJECTOR}function getParentInjectorIndex(parentLocation){return 32767&parentLocation}function getParentInjectorViewOffset(parentLocation){return parentLocation>>16}function getParentInjectorView(location,startView){for(var viewOffset=getParentInjectorViewOffset(location),parentView=startView;viewOffset>0;)parentView=parentView[DECLARATION_VIEW],viewOffset--;return parentView}var renderer,rendererFactory,elementDepthCount,bindingsEnabled,previousOrParentTNode,isParent,tView,currentQueries,creationMode,viewData,defaultScheduler=("undefined"!=typeof requestAnimationFrame&&requestAnimationFrame||setTimeout).bind(_global);function getContext(target){var element,instance,mpValue=readPatchedData(target);if(mpValue){if(Array.isArray(mpValue)){var lViewData=mpValue,nodeIndex=void 0,component=void 0,directives=void 0;if(isComponentInstance(target)){if(-1==(nodeIndex=findViaComponent(lViewData,target)))throw new Error("The provided component was not found in the application");component=target}else if((instance=target)&&instance.constructor&&instance.constructor.ngDirectiveDef){if(-1==(nodeIndex=function(lViewData,directiveInstance){var tNode=lViewData[TVIEW].firstChild;for(;tNode;){for(var directiveIndexStart=getDirectiveStartIndex(tNode),directiveIndexEnd=getDirectiveEndIndex(tNode,directiveIndexStart),i=directiveIndexStart;i<directiveIndexEnd;i++)if(lViewData[i]===directiveInstance)return tNode.index;tNode=traverseNextElement(tNode)}return-1}(lViewData,target)))throw new Error("The provided directive was not found in the application");directives=discoverDirectives(nodeIndex,lViewData,!1)}else if(-1==(nodeIndex=findViaNativeElement(lViewData,target)))return null;var existingCtx=readPatchedData(native=readElementValue(lViewData[nodeIndex])),context=existingCtx&&!Array.isArray(existingCtx)?existingCtx:createLContext(lViewData,nodeIndex,native);if(component&&void 0===context.component&&(context.component=component,attachPatchData(context.component,context)),directives&&void 0===context.directives){context.directives=directives;for(var i=0;i<directives.length;i++)attachPatchData(directives[i],context)}attachPatchData(context.native,context),mpValue=context}}else{var rElement=target;ngDevMode&&assertEqual((element=rElement)&&(element.nodeType==Node.ELEMENT_NODE||element.nodeType==Node.TEXT_NODE),!0,"The provided value must be an instance of an HTMLElement");for(var parent_1=rElement;parent_1=parent_1.parentNode;){var parentContext=readPatchedData(parent_1);if(parentContext){lViewData=void 0;if(!(lViewData=Array.isArray(parentContext)?parentContext:parentContext.lViewData))return null;var index=findViaNativeElement(lViewData,rElement);if(index>=0){var native;attachPatchData(native=readElementValue(lViewData[index]),context=createLContext(lViewData,index,native)),mpValue=context;break}}}}return mpValue||null}function createLContext(lViewData,nodeIndex,native){return{lViewData:lViewData,nodeIndex:nodeIndex,native:native,component:void 0,directives:void 0,localRefs:void 0}}function getComponentViewByInstance(componentInstance){var view,lViewData=readPatchedData(componentInstance);if(Array.isArray(lViewData)){var nodeIndex=findViaComponent(lViewData,componentInstance);(context=createLContext(lViewData,nodeIndex,(view=getComponentViewByIndex(nodeIndex,lViewData))[HOST])).component=componentInstance,attachPatchData(componentInstance,context),attachPatchData(context.native,context)}else{var context;view=getComponentViewByIndex((context=lViewData).nodeIndex,context.lViewData)}return view}function attachPatchData(target,data){target[MONKEY_PATCH_KEY_NAME]=data}function isComponentInstance(instance){return instance&&instance.constructor&&instance.constructor.ngComponentDef}function findViaNativeElement(lViewData,target){for(var tNode=lViewData[TVIEW].firstChild;tNode;){if(getNativeByTNode(tNode,lViewData)===target)return tNode.index;tNode=traverseNextElement(tNode)}return-1}function traverseNextElement(tNode){return tNode.child?tNode.child:tNode.next?tNode.next:tNode.parent&&tNode.parent.next||null}function findViaComponent(lViewData,componentInstance){var componentIndices=lViewData[TVIEW].components;if(componentIndices)for(var i=0;i<componentIndices.length;i++){var elementComponentIndex=componentIndices[i];if(getComponentViewByIndex(elementComponentIndex,lViewData)[CONTEXT]===componentInstance)return elementComponentIndex}else if(getComponentViewByIndex(HEADER_OFFSET,lViewData)[CONTEXT]===componentInstance)return HEADER_OFFSET;return-1}function discoverDirectives(nodeIndex,lViewData,includeComponents){var tNode=lViewData[TVIEW].data[nodeIndex],directiveStartIndex=getDirectiveStartIndex(tNode),directiveEndIndex=getDirectiveEndIndex(tNode,directiveStartIndex);return!includeComponents&&4096&tNode.flags&&directiveStartIndex++,lViewData.slice(directiveStartIndex,directiveEndIndex)}function getDirectiveStartIndex(tNode){return tNode.flags>>16}function getDirectiveEndIndex(tNode,startIndex){var count=4095&tNode.flags;return count?startIndex+count:-1}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function queueInitHooks(index,onInit,doCheck,tView){ngDevMode&&assertEqual(tView.firstTemplatePass,!0,"Should only be called on first template pass"),onInit&&(tView.initHooks||(tView.initHooks=[])).push(index,onInit),doCheck&&((tView.initHooks||(tView.initHooks=[])).push(index,doCheck),(tView.checkHooks||(tView.checkHooks=[])).push(index,doCheck))}function queueLifecycleHooks(flags,tView){if(tView.firstTemplatePass)for(var start=flags>>16,end=start+(4095&flags),i=start;i<end;i++){var def=tView.data[i];queueContentHooks(def,tView,i),queueViewHooks(def,tView,i),queueDestroyHooks(def,tView,i)}}function queueContentHooks(def,tView,i){def.afterContentInit&&(tView.contentHooks||(tView.contentHooks=[])).push(i,def.afterContentInit),def.afterContentChecked&&((tView.contentHooks||(tView.contentHooks=[])).push(i,def.afterContentChecked),(tView.contentCheckHooks||(tView.contentCheckHooks=[])).push(i,def.afterContentChecked))}function queueViewHooks(def,tView,i){def.afterViewInit&&(tView.viewHooks||(tView.viewHooks=[])).push(i,def.afterViewInit),def.afterViewChecked&&((tView.viewHooks||(tView.viewHooks=[])).push(i,def.afterViewChecked),(tView.viewCheckHooks||(tView.viewCheckHooks=[])).push(i,def.afterViewChecked))}function queueDestroyHooks(def,tView,i){null!=def.onDestroy&&(tView.destroyHooks||(tView.destroyHooks=[])).push(i,def.onDestroy)}function executeInitHooks(currentView,tView,creationMode){16&currentView[FLAGS]&&(executeHooks(currentView,tView.initHooks,tView.checkHooks,creationMode),currentView[FLAGS]&=-17)}function executeHooks(data,allHooks,checkHooks,creationMode){var hooksToCall=creationMode?allHooks:checkHooks;hooksToCall&&callHooks(data,hooksToCall)}function callHooks(currentView,arr){for(var i=0;i<arr.length;i+=2)arr[i+1].call(currentView[arr[i]])}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function getRenderer(){return renderer}function getRendererFactory(){return rendererFactory}function getCurrentSanitizer(){return viewData&&viewData[SANITIZER]}function enableBindings(){bindingsEnabled=!0}function disableBindings(){bindingsEnabled=!1}function getCurrentView(){return viewData}function restoreView(viewToRestore){contextViewData=viewToRestore}function getPreviousOrParentTNode(){return previousOrParentTNode}function setPreviousOrParentTNode(tNode){previousOrParentTNode=tNode}function setTNodeAndViewData(tNode,view){previousOrParentTNode=tNode,viewData=view}function getIsParent(){return isParent}function setIsParent(value){isParent=value}function getTView(){return tView}function getCurrentQueries(){return currentQueries}function setCurrentQueries(queries){currentQueries=queries}function getCreationMode(){return creationMode}function getViewData(){return viewData}var contextViewData=null;function getContextViewData(){return contextViewData}function getCleanup(view){return view[CLEANUP]||(view[CLEANUP]=[])}function getTViewCleanup(view){return view[TVIEW].cleanup||(view[TVIEW].cleanup=[])}var checkNoChangesMode=!1;function getCheckNoChangesMode(){return checkNoChangesMode}function setCheckNoChangesMode(mode){checkNoChangesMode=mode}var firstTemplatePass=!0;function getFirstTemplatePass(){return firstTemplatePass}function setFirstTemplatePass(value){firstTemplatePass=value}var bindingRootIndex=-1;function getBindingRoot(){return bindingRootIndex}function setBindingRoot(value){bindingRootIndex=value}function enterView(newView,hostTNode){var oldView=viewData;return tView=newView&&newView[TVIEW],creationMode=newView&&1==(1&newView[FLAGS]),firstTemplatePass=newView&&tView.firstTemplatePass,bindingRootIndex=newView&&tView.bindingStartIndex,renderer=newView&&newView[RENDERER],previousOrParentTNode=hostTNode,isParent=!0,viewData=contextViewData=newView,oldView&&(oldView[QUERIES]=currentQueries),currentQueries=newView&&newView[QUERIES],oldView}function nextContextImpl(level){return void 0===level&&(level=1),(contextViewData=function(nestingLevel,currentView){for(;nestingLevel>0;)ngDevMode&&assertDefined(currentView[DECLARATION_VIEW],"Declaration view should be defined if nesting level is greater than 0."),currentView=currentView[DECLARATION_VIEW],nestingLevel--;return currentView}(level,contextViewData))[CONTEXT]}function resetComponentState(){isParent=!1,previousOrParentTNode=null,elementDepthCount=0,bindingsEnabled=!0}function leaveView(newView,creationOnly){creationOnly||(checkNoChangesMode||executeHooks(viewData,tView.viewHooks,tView.viewCheckHooks,creationMode),viewData[FLAGS]&=-6),viewData[FLAGS]|=16,viewData[BINDING_INDEX]=tView.bindingStartIndex,enterView(newView,null)}function assertPreviousIsParent(){assertEqual(isParent,!0,"previousOrParentTNode should be a parent")}function assertHasParent(){assertDefined(previousOrParentTNode.parent,"previousOrParentTNode should have a parent")}function assertDataInRange(index,arr){null==arr&&(arr=viewData),assertDataInRangeInternal(index,arr||viewData)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var includeViewProviders=!1;function setIncludeViewProviders(v){var oldValue=includeViewProviders;return includeViewProviders=v,oldValue}var BLOOM_MASK=255,nextNgElementId=0;function getOrCreateNodeInjectorForNode(tNode,hostView){var existingInjectorIndex=getInjectorIndex(tNode,hostView);if(-1!==existingInjectorIndex)return existingInjectorIndex;var tView=hostView[TVIEW];tView.firstTemplatePass&&(tNode.injectorIndex=hostView.length,insertBloom(tView.data,tNode),insertBloom(hostView,null),insertBloom(tView.blueprint,null),ngDevMode&&assertEqual(0===tNode.flags||4096===tNode.flags,!0,"expected tNode.flags to not be initialized"));var parentLoc=getParentInjectorLocation(tNode,hostView),parentIndex=getParentInjectorIndex(parentLoc),parentView=getParentInjectorView(parentLoc,hostView),injectorIndex=tNode.injectorIndex;if(hasParentInjector(parentLoc))for(var parentData=parentView[TVIEW].data,i=0;i<8;i++)hostView[injectorIndex+i]=parentView[parentIndex+i]|parentData[parentIndex+i];return hostView[injectorIndex+PARENT_INJECTOR]=parentLoc,injectorIndex}function insertBloom(arr,footer){arr.push(0,0,0,0,0,0,0,0,footer)}function getInjectorIndex(tNode,hostView){return-1===tNode.injectorIndex||tNode.parent&&tNode.parent.injectorIndex===tNode.injectorIndex||null==hostView[tNode.injectorIndex+PARENT_INJECTOR]?-1:tNode.injectorIndex}function getParentInjectorLocation(tNode,view){if(tNode.parent&&-1!==tNode.parent.injectorIndex)return tNode.parent.injectorIndex;for(var hostTNode=view[HOST_NODE],viewOffset=1;hostTNode&&-1===hostTNode.injectorIndex;)hostTNode=(view=view[DECLARATION_VIEW])[HOST_NODE],viewOffset++;var acrossHostBoundary=hostTNode&&3===hostTNode.type?32768:0;return hostTNode?hostTNode.injectorIndex|viewOffset<<16|acrossHostBoundary:-1}function diPublicInInjector(injectorIndex,view,token){!function(injectorIndex,tView,type){ngDevMode&&assertEqual(tView.firstTemplatePass,!0,"expected firstTemplatePass to be true");var id=type[NG_ELEMENT_ID];null==id&&(id=type[NG_ELEMENT_ID]=nextNgElementId++);var bloomBit=id&BLOOM_MASK,mask=1<<bloomBit,b7=128&bloomBit,b6=64&bloomBit,b5=32&bloomBit,tData=tView.data;b7?b6?b5?tData[injectorIndex+7]|=mask:tData[injectorIndex+6]|=mask:b5?tData[injectorIndex+5]|=mask:tData[injectorIndex+4]|=mask:b6?b5?tData[injectorIndex+3]|=mask:tData[injectorIndex+2]|=mask:b5?tData[injectorIndex+1]|=mask:tData[injectorIndex]|=mask}(injectorIndex,view[TVIEW],token)}function injectAttributeImpl(tNode,attrNameToInject){ngDevMode&&assertNodeOfPossibleTypes(tNode,0,3,4),ngDevMode&&assertDefined(tNode,"expecting tNode");var attrs=tNode.attrs;if(attrs)for(var i=0;i<attrs.length;i+=2){var attrName=attrs[i];if(1===attrName)break;if(attrName==attrNameToInject)return attrs[i+1]}}function getOrCreateInjectable(tNode,lViewData,token,flags,notFoundValue){void 0===flags&&(flags=0);var bloomHash=function(token){ngDevMode&&assertDefined(token,"token must be defined");var tokenId=token[NG_ELEMENT_ID];return"number"==typeof tokenId?tokenId&BLOOM_MASK:tokenId}(token);if("function"==typeof bloomHash){var savePreviousOrParentTNode=getPreviousOrParentTNode(),saveViewData=getViewData();setTNodeAndViewData(tNode,lViewData);try{var value=bloomHash();if(null!=value||8&flags)return value;throw new Error("No provider for "+stringify$1(token))}finally{setTNodeAndViewData(savePreviousOrParentTNode,saveViewData)}}else if("number"==typeof bloomHash){var previousTView=null,injectorIndex=getInjectorIndex(tNode,lViewData),parentLocation=NO_PARENT_INJECTOR;for(4&flags&&(shouldSearchParent(flags,parentLocation=-1===injectorIndex?getParentInjectorLocation(tNode,lViewData):lViewData[injectorIndex+PARENT_INJECTOR])?(previousTView=lViewData[TVIEW],injectorIndex=getParentInjectorIndex(parentLocation),lViewData=getParentInjectorView(parentLocation,lViewData)):injectorIndex=-1);-1!==injectorIndex;){parentLocation=lViewData[injectorIndex+PARENT_INJECTOR];var tView=lViewData[TVIEW];if(bloomHasToken(bloomHash,injectorIndex,tView.data)){var instance=searchTokensOnInjector(injectorIndex,lViewData,token,previousTView);if(instance!==NOT_FOUND)return instance}shouldSearchParent(flags,parentLocation)&&bloomHasToken(bloomHash,injectorIndex,lViewData)?(previousTView=tView,injectorIndex=getParentInjectorIndex(parentLocation),lViewData=getParentInjectorView(parentLocation,lViewData)):injectorIndex=-1}}if(8&flags&&void 0===notFoundValue&&(notFoundValue=null),0==(3&flags)){var moduleInjector=lViewData[INJECTOR];return moduleInjector?moduleInjector.get(token,notFoundValue,8&flags):injectRootLimpMode(token,notFoundValue,8&flags)}if(8&flags)return notFoundValue;throw new Error("NodeInjector: NOT_FOUND ["+stringify$1(token)+"]")}var NOT_FOUND={};function searchTokensOnInjector(injectorIndex,injectorView,token,previousTView){var currentTView=injectorView[TVIEW],tNode=currentTView.data[injectorIndex+TNODE],nodeFlags=tNode.flags,nodeProviderIndexes=tNode.providerIndexes,tInjectables=currentTView.data,canAccessViewProviders=!1;(null==previousTView&&isComponent(tNode)&&includeViewProviders||null!=previousTView&&previousTView!=currentTView&&(null==currentTView.node||3===currentTView.node.type))&&(canAccessViewProviders=!0);for(var startInjectables=65535&nodeProviderIndexes,startDirectives=nodeFlags>>16,directiveCount=4095&nodeFlags,i=canAccessViewProviders?startInjectables:startInjectables+(nodeProviderIndexes>>16);i<startDirectives+directiveCount;i++){var providerTokenOrDef=tInjectables[i];if(i<startDirectives&&token===providerTokenOrDef||i>=startDirectives&&providerTokenOrDef.type===token)return getNodeInjectable(tInjectables,injectorView,i,tNode)}return NOT_FOUND}function getNodeInjectable(tData,lData,index,tNode){var obj,value=lData[index];if(null!=(obj=value)&&"object"==typeof obj&&Object.getPrototypeOf(obj)==FactoryPrototype){var factory=value;if(factory.resolving)throw new Error("Circular dep for "+stringify$1(tData[index]));var previousIncludeViewProviders=setIncludeViewProviders(factory.canSeeViewProviders);factory.resolving=!0;var previousInjectImplementation=void 0;factory.injectImpl&&(previousInjectImplementation=setInjectImplementation(factory.injectImpl));var savePreviousOrParentTNode=getPreviousOrParentTNode(),saveViewData=getViewData();setTNodeAndViewData(tNode,lData);try{value=lData[index]=factory.factory(null,tData,lData,tNode)}finally{factory.injectImpl&&setInjectImplementation(previousInjectImplementation),setIncludeViewProviders(previousIncludeViewProviders),factory.resolving=!1,setTNodeAndViewData(savePreviousOrParentTNode,saveViewData)}}return value}function bloomHasToken(bloomHash,injectorIndex,injectorView){var mask=1<<bloomHash,b6=64&bloomHash,b5=32&bloomHash;return!!((128&bloomHash?b6?b5?injectorView[injectorIndex+7]:injectorView[injectorIndex+6]:b5?injectorView[injectorIndex+5]:injectorView[injectorIndex+4]:b6?b5?injectorView[injectorIndex+3]:injectorView[injectorIndex+2]:b5?injectorView[injectorIndex+1]:injectorView[injectorIndex])&mask)}function shouldSearchParent(flags,parentLocation){return!(2&flags||1&flags&&32768&parentLocation)}var NodeInjector=function(){function NodeInjector(_tNode,_hostView){this._tNode=_tNode,this._hostView=_hostView,this._injectorIndex=getOrCreateNodeInjectorForNode(_tNode,_hostView)}return NodeInjector.prototype.get=function(token){return setTNodeAndViewData(this._tNode,this._hostView),getOrCreateInjectable(this._tNode,this._hostView,token)},NodeInjector}();function getFactoryOf(type){var typeAny=type,def=getComponentDef(typeAny)||getDirectiveDef(typeAny)||getPipeDef(typeAny)||getInjectableDef(typeAny)||getInjectorDef(typeAny);return def&&void 0!==def.factory?def.factory:null}function getInheritedFactory(type){var factory=getFactoryOf(Object.getPrototypeOf(type.prototype).constructor);return null!==factory?factory:function(t){return new t}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function noop(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i]}function throwMultipleComponentError(tNode){throw new Error("Multiple components match node with tagname "+tNode.tagName)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var NG_PROJECT_AS_ATTR_NAME="ngProjectAs",RendererStyleFlags3={Important:1,DashCase:2};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function isProceduralRenderer(renderer){return!!renderer.listen}RendererStyleFlags3[RendererStyleFlags3.Important]="Important",RendererStyleFlags3[RendererStyleFlags3.DashCase]="DashCase";var domRendererFactory3={createRenderer:function(hostElement,rendererType){return document}};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var NO_CHANGE={};var BoundPlayerFactory=function(){return function(fn,value){this.fn=fn,this.value=value}}(),CorePlayerHandler=function(){function CorePlayerHandler(){this._players=[]}return CorePlayerHandler.prototype.flushPlayers=function(){for(var i=0;i<this._players.length;i++){var player=this._players[i];player.parent||0!==player.state||player.play()}this._players.length=0},CorePlayerHandler.prototype.queuePlayer=function(player){this._players.push(player)},CorePlayerHandler}();function createEmptyStylingContext(element,sanitizer,initialStylingValues){return[null,sanitizer||null,initialStylingValues||[null],0,0,element||null,null,null]}function getStylingContext(index,viewData){for(var storageIndex=index+HEADER_OFFSET,slotValue=viewData[storageIndex],wrapper=viewData;Array.isArray(slotValue);)wrapper=slotValue,slotValue=slotValue[HOST];if("number"!=typeof(value=wrapper)[FLAGS]&&"number"!=typeof value[ACTIVE_INDEX])return wrapper;var element,context,value,stylingTemplate=getTNode(index,viewData).stylingTemplate;return wrapper!==viewData&&(storageIndex=HOST),wrapper[storageIndex]=stylingTemplate?(element=slotValue,(context=stylingTemplate.slice())[5]=element,context):createEmptyStylingContext(slotValue)}function addPlayerInternal(playerContext,rootContext,element,player,playerContextIndex,ref){return ref=ref||element,playerContextIndex?playerContext[playerContextIndex]=player:playerContext.push(player),!!player&&(player.addEventListener(200,function(){var index=playerContext.indexOf(player),nonFactoryPlayerIndex=playerContext[0];index&&(index<nonFactoryPlayerIndex?playerContext[index]=null:playerContext.splice(index,1)),player.destroy()}),(rootContext.playerHandler||(rootContext.playerHandler=new CorePlayerHandler)).queuePlayer(player,ref),!0)}function getPlayerContext(stylingContext){return stylingContext[0]}function allocPlayerContext(data){return data[0]=[5,null,null,null,null]}function throwInvalidRefError(){throw new Error("Only elements that exist in an Angular application can be used for animations")}var EMPTY_ARR=[],EMPTY_OBJ$1={};function updateStyleProp(context,index,input){var singleIndex=8+4*index,currValue=getValue(context,singleIndex),currFlag=getPointers(context,singleIndex);if(hasValueChanged(currFlag,currValue,input instanceof BoundPlayerFactory?input.value:input)){var isClassBased_5=2==(2&currFlag),element=context[5],playerBuilder=input instanceof BoundPlayerFactory?new ClassAndStylePlayerBuilder(input,element,isClassBased_5?1:2):null,value_1=playerBuilder?input.value:input,currPlayerIndex=getPlayerBuilderIndex(context,singleIndex),playerBuildersAreDirty=!1;if(hasPlayerBuilderChanged(context,playerBuilder,currPlayerIndex)){var newIndex=setPlayerBuilder(context,playerBuilder,currPlayerIndex);setPlayerBuilderIndex(context,singleIndex,playerBuilder?newIndex:0),playerBuildersAreDirty=!0}setValue(context,singleIndex,value_1);var indexForMulti=getMultiOrSingleIndex(currFlag),valueForMulti=getValue(context,indexForMulti);if(!valueForMulti||hasValueChanged(currFlag,valueForMulti,value_1)){var multiDirty=!1,singleDirty=!0;!valueExists(value_1,isClassBased_5)&&valueExists(valueForMulti,isClassBased_5)&&(multiDirty=!0,singleDirty=!1),setDirty(context,indexForMulti,multiDirty),setDirty(context,singleIndex,singleDirty),setContextDirty(context,!0)}playerBuildersAreDirty&&setContextPlayersDirty(context,!0)}}function renderStyleAndClassBindings(context,renderer,rootOrView,isFirstRender,classesStore,stylesStore){var totalPlayersQueued=0;if(function(context){return isDirty(context,3)}(context)){for(var flushPlayerBuilders=8&context[3],native=context[5],multiStartIndex=getMultiStartIndex(context),styleSanitizer=getStyleSanitizer(context),onlySingleClasses=limitToSingleClasses(context),i=8;i<context.length;i+=4)if(isDirty(context,i)){var prop=getProp(context,i),value=getValue(context,i),flag=getPointers(context,i),playerBuilder=getPlayerBuilder(context,i),isClassBased_6=!!(2&flag),readInitialValue=!isClassBased_6||!onlySingleClasses,valueToApply=value;if(i<multiStartIndex&&!valueExists(valueToApply,isClassBased_6))valueToApply=getValue(context,getMultiOrSingleIndex(flag));if(!valueExists(valueToApply,isClassBased_6)&&readInitialValue&&(valueToApply=getInitialValue(context,flag)),!isFirstRender||valueToApply)if(isClassBased_6)setClass(native,prop,!!valueToApply,renderer,classesStore,playerBuilder);else setStyle(native,prop,valueToApply,renderer,4&flag?styleSanitizer:null,stylesStore,playerBuilder);setDirty(context,i,!1)}if(flushPlayerBuilders){var rootContext=Array.isArray(rootOrView)?getRootContext$1(rootOrView):rootOrView,playerContext=getPlayerContext(context),playersStartIndex=playerContext[0];for(i=1;i<playersStartIndex;i+=2){var builder=playerContext[i],playerInsertionIndex=i+1,oldPlayer=playerContext[playerInsertionIndex];if(builder){var player=builder.buildPlayer(oldPlayer,isFirstRender);if(void 0!==player){if(null!=player)addPlayerInternal(playerContext,rootContext,native,player,playerInsertionIndex)&&totalPlayersQueued++;oldPlayer&&oldPlayer.destroy()}}else oldPlayer&&oldPlayer.destroy()}setContextPlayersDirty(context,!1)}setContextDirty(context,!1)}return totalPlayersQueued}function setStyle(native,prop,value,renderer,sanitizer,store,playerBuilder){value=sanitizer&&value?sanitizer(prop,value):value,store||playerBuilder?(store&&store.setValue(prop,value),playerBuilder&&playerBuilder.setValue(prop,value)):value?(ngDevMode&&ngDevMode.rendererSetStyle++,isProceduralRenderer(renderer)?renderer.setStyle(native,prop,value,RendererStyleFlags3.DashCase):native.style.setProperty(prop,value)):(ngDevMode&&ngDevMode.rendererRemoveStyle++,isProceduralRenderer(renderer)?renderer.removeStyle(native,prop,RendererStyleFlags3.DashCase):native.style.removeProperty(prop))}function setClass(native,className,add,renderer,store,playerBuilder){store||playerBuilder?(store&&store.setValue(className,add),playerBuilder&&playerBuilder.setValue(className,add)):add?(ngDevMode&&ngDevMode.rendererAddClass++,isProceduralRenderer(renderer)?renderer.addClass(native,className):native.classList.add(className)):(ngDevMode&&ngDevMode.rendererRemoveClass++,isProceduralRenderer(renderer)?renderer.removeClass(native,className):native.classList.remove(className))}function setDirty(context,index,isDirtyYes){var adjustedIndex=index>=8?index+0:index;isDirtyYes?context[adjustedIndex]|=1:context[adjustedIndex]&=-2}function isDirty(context,index){return 1==(1&context[index>=8?index+0:index])}function isClassBased(context,index){return 2==(2&context[index>=8?index+0:index])}function isSanitizable(context,index){return 4==(4&context[index>=8?index+0:index])}function pointers(configFlag,staticIndex,dynamicIndex){return 31&configFlag|staticIndex<<5|dynamicIndex<<19}function getInitialValue(context,flag){var index=getInitialIndex(flag);return context[2][index]}function getInitialIndex(flag){return flag>>5&16383}function getMultiOrSingleIndex(flag){var index=flag>>19&16383;return index>=8?index:-1}function getMultiStartIndex(context){return getMultiOrSingleIndex(context[3])}function getStyleSanitizer(context){return context[1]}function setProp(context,index,prop){context[index+1]=prop}function setValue(context,index,value){context[index+2]=value}function hasPlayerBuilderChanged(context,builder,index){var playerContext=context[0];if(builder){if(!playerContext||0===index)return!0}else if(!playerContext)return!1;return playerContext[index]!==builder}function setPlayerBuilder(context,builder,insertionIndex){var playerContext=context[0]||allocPlayerContext(context);return insertionIndex>0?playerContext[insertionIndex]=builder:(insertionIndex=playerContext[0],playerContext.splice(insertionIndex,0,builder,null),playerContext[0]+=2),insertionIndex}function setPlayerBuilderIndex(context,index,playerBuilderIndex){context[index+3]=playerBuilderIndex}function getPlayerBuilderIndex(context,index){return context[index+3]||0}function getPlayerBuilder(context,index){var playerBuilderIndex=getPlayerBuilderIndex(context,index);if(playerBuilderIndex){var playerContext=context[0];if(playerContext)return playerContext[playerBuilderIndex]}return null}function setFlag(context,index,flag){context[3===index?index:index+0]=flag}function getPointers(context,index){return context[3===index?index:index+0]}function getValue(context,index){return context[index+2]}function getProp(context,index){return context[index+1]}function limitToSingleClasses(context){return 16&context[3]}function setContextDirty(context,isDirtyYes){setDirty(context,3,isDirtyYes)}function setContextPlayersDirty(context,isDirtyYes){isDirtyYes?context[3]|=8:context[3]&=-9}function findEntryPositionByProp(context,prop,startIndex){for(var i=(startIndex||0)+1;i<context.length;i+=4){if(context[i]==prop)return i-1}return-1}function swapMultiContextEntries(context,indexA,indexB){var tmpValue=getValue(context,indexA),tmpProp=getProp(context,indexA),tmpFlag=getPointers(context,indexA),tmpPlayerBuilderIndex=getPlayerBuilderIndex(context,indexA),flagA=tmpFlag,flagB=getPointers(context,indexB),singleIndexA=getMultiOrSingleIndex(flagA);singleIndexA>=0&&setFlag(context,singleIndexA,pointers(_flag=getPointers(context,singleIndexA),getInitialIndex(_flag),indexB));var _flag,singleIndexB=getMultiOrSingleIndex(flagB);singleIndexB>=0&&setFlag(context,singleIndexB,pointers(_flag=getPointers(context,singleIndexB),getInitialIndex(_flag),indexA));setValue(context,indexA,getValue(context,indexB)),setProp(context,indexA,getProp(context,indexB)),setFlag(context,indexA,getPointers(context,indexB)),setPlayerBuilderIndex(context,indexA,getPlayerBuilderIndex(context,indexB)),setValue(context,indexB,tmpValue),setProp(context,indexB,tmpProp),setFlag(context,indexB,tmpFlag),setPlayerBuilderIndex(context,indexB,tmpPlayerBuilderIndex)}function insertNewMultiProperty(context,index,classBased,name,flag,value,playerIndex){var doShift=index<context.length;context.splice(index,0,1|flag|(classBased?2:0),name,value,playerIndex),doShift&&function(context,indexStartPosition){for(var i=indexStartPosition;i<context.length;i+=4){var singleIndex=getMultiOrSingleIndex(getPointers(context,i));if(singleIndex>0){var initialIndexForSingle=getInitialIndex(getPointers(context,singleIndex));setFlag(context,singleIndex,pointers((isDirty(context,singleIndex)?1:0)|(isClassBased(context,singleIndex)?2:0)|(isSanitizable(context,singleIndex)?4:0),initialIndexForSingle,i))}}}(context,index+4)}function valueExists(value,isClassBased){return isClassBased?!!value:null!==value}function prepareInitialFlag(name,isClassBased,sanitizer){return isClassBased?2:sanitizer&&sanitizer(name)?4:0}function hasValueChanged(flag,a,b){return!(2&flag)&&(a&&b)&&4&flag?a.toString()!==b.toString():a!==b}var ClassAndStylePlayerBuilder=function(){function ClassAndStylePlayerBuilder(factory,_element,_type){this._element=_element,this._type=_type,this._values={},this._dirty=!1,this._factory=factory}return ClassAndStylePlayerBuilder.prototype.setValue=function(prop,value){this._values[prop]!==value&&(this._values[prop]=value,this._dirty=!0)},ClassAndStylePlayerBuilder.prototype.buildPlayer=function(currentPlayer,isFirstRender){if(this._dirty){var player=this._factory.fn(this._element,this._type,this._values,isFirstRender,currentPlayer||null);return this._values={},this._dirty=!1,player}},ClassAndStylePlayerBuilder}(),_CLEAN_PROMISE=Promise.resolve(null);
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function refreshDescendantViews(viewData,rf){var tView=getTView(),parentFirstTemplatePass=getFirstTemplatePass();if(tView.firstTemplatePass=!1,setFirstTemplatePass(!1),1!==rf){var creationMode=getCreationMode(),checkNoChangesMode=getCheckNoChangesMode();checkNoChangesMode||executeInitHooks(viewData,tView,creationMode),function(tView,viewData){if(tView.expandoInstructions){var bindingRootIndex=viewData[BINDING_INDEX]=tView.expandoStartIndex;setBindingRoot(bindingRootIndex);for(var currentDirectiveIndex=-1,currentElementIndex=-1,i=0;i<tView.expandoInstructions.length;i++){var instruction=tView.expandoInstructions[i];if("number"==typeof instruction){if(instruction<=0){currentElementIndex=-instruction;var providerCount=tView.expandoInstructions[++i];currentDirectiveIndex=bindingRootIndex+=INJECTOR_SIZE+providerCount}else bindingRootIndex+=instruction;setBindingRoot(bindingRootIndex)}else viewData[BINDING_INDEX]=bindingRootIndex,instruction(currentDirectiveIndex-HEADER_OFFSET,currentElementIndex),currentDirectiveIndex++}}}(tView,viewData),function(lViewData){for(var current=getLViewChild(lViewData);null!==current;current=current[NEXT])if(current.length<HEADER_OFFSET&&-1===current[ACTIVE_INDEX])for(var container_1=current,i=0;i<container_1[VIEWS].length;i++){var dynamicViewData=container_1[VIEWS][i];ngDevMode&&assertDefined(dynamicViewData[TVIEW],"TView must be allocated"),renderEmbeddedTemplate(dynamicViewData,dynamicViewData[TVIEW],dynamicViewData[CONTEXT],2)}}(viewData),function(tView){if(null!=tView.contentQueries)for(var i=0;i<tView.contentQueries.length;i+=2){var directiveDefIdx=tView.contentQueries[i],directiveDef=tView.data[directiveDefIdx];directiveDef.contentQueriesRefresh(directiveDefIdx-HEADER_OFFSET,tView.contentQueries[i+1])}}(tView),checkNoChangesMode||executeHooks(viewData,tView.contentHooks,tView.contentCheckHooks,creationMode)}!function(components,parentFirstTemplatePass,rf){if(null!=components)for(var i=0;i<components.length;i++)componentRefresh(components[i],parentFirstTemplatePass,rf)}(tView.components,parentFirstTemplatePass,rf)}function createLViewData(renderer,tView,context,flags,sanitizer){var viewData=getViewData(),instance=tView.blueprint.slice();return instance[FLAGS]=25|flags,instance[PARENT]=instance[DECLARATION_VIEW]=viewData,instance[CONTEXT]=context,instance[INJECTOR]=viewData?viewData[INJECTOR]:null,instance[RENDERER]=renderer,instance[SANITIZER]=sanitizer||null,instance}function createNodeAtIndex(index,type,native,name,attrs){var viewData=getViewData(),tView=getTView(),adjustedIndex=index+HEADER_OFFSET;ngDevMode&&assertLessThan(adjustedIndex,viewData.length,"Slot should have been initialized with null"),viewData[adjustedIndex]=native;var tNode=tView.data[adjustedIndex];if(null==tNode){var previousOrParentTNode=getPreviousOrParentTNode(),isParent=getIsParent();tNode=tView.data[adjustedIndex]=createTNode(viewData,type,adjustedIndex,name,attrs,null),previousOrParentTNode&&(!isParent||null!=previousOrParentTNode.child||null===tNode.parent&&2!==previousOrParentTNode.type?isParent||(previousOrParentTNode.next=tNode):previousOrParentTNode.child=tNode)}return null==tView.firstChild&&3===type&&(tView.firstChild=tNode),setPreviousOrParentTNode(tNode),setIsParent(!0),tNode}function createViewNode(index,view){null==view[TVIEW].node&&(view[TVIEW].node=createTNode(view,2,index,null,null,null)),setIsParent(!0);var tNode=view[TVIEW].node;return setPreviousOrParentTNode(tNode),view[HOST_NODE]=tNode}function renderEmbeddedTemplate(viewToRender,tView,context,rf){var oldView,_isParent=getIsParent(),_previousOrParentTNode=getPreviousOrParentTNode();if(setIsParent(!0),setPreviousOrParentTNode(null),64&viewToRender[FLAGS])tickRootContext(getRootContext$1(viewToRender));else try{setIsParent(!0),setPreviousOrParentTNode(null),oldView=enterView(viewToRender,viewToRender[HOST_NODE]),namespaceHTML(),tView.template(rf,context),2&rf?refreshDescendantViews(viewToRender,null):(viewToRender[TVIEW].firstTemplatePass=!1,setFirstTemplatePass(!1))}finally{leaveView(oldView,1==(1&rf)),setIsParent(_isParent),setPreviousOrParentTNode(_previousOrParentTNode)}}function nextContext(level){return void 0===level&&(level=1),nextContextImpl(level)}function renderComponentOrTemplate(hostView,componentOrContext,rf,templateFn){var rendererFactory=getRendererFactory(),oldView=enterView(hostView,hostView[HOST_NODE]);try{rendererFactory.begin&&rendererFactory.begin(),templateFn&&(namespaceHTML(),templateFn(rf||getRenderFlags(hostView),componentOrContext)),refreshDescendantViews(hostView,rf)}finally{rendererFactory.end&&rendererFactory.end(),leaveView(oldView)}}function getRenderFlags(view){return 1&view[FLAGS]?3:2}var _currentNamespace=null;function namespaceSVG(){_currentNamespace="http://www.w3.org/2000/svg/"}function namespaceMathML(){_currentNamespace="http://www.w3.org/1998/MathML/"}function namespaceHTML(){_currentNamespace=null}function element(index,name,attrs,localRefs){elementStart(index,name,attrs,localRefs),elementEnd()}function elementStart(index,name,attrs,localRefs){var viewData=getViewData(),tView=getTView();ngDevMode&&assertEqual(viewData[BINDING_INDEX],tView.bindingStartIndex,"elements should be created before any bindings "),ngDevMode&&ngDevMode.rendererCreateElement++;var native=elementCreate(name);ngDevMode&&assertDataInRange(index-1);var tNode=createNodeAtIndex(index,3,native,name,attrs||null);attrs&&setUpAttributes(native,attrs),appendChild(native,tNode,viewData),createDirectivesAndLocals(tView,viewData,localRefs),0===elementDepthCount&&attachPatchData(native,viewData),elementDepthCount++}function elementCreate(name,overriddenRenderer){var rendererToUse=overriddenRenderer||getRenderer();return isProceduralRenderer(rendererToUse)?rendererToUse.createElement(name,_currentNamespace):null===_currentNamespace?rendererToUse.createElement(name):rendererToUse.createElementNS(_currentNamespace,name)}function createDirectivesAndLocals(tView,viewData,localRefs,localRefExtractor){if(void 0===localRefExtractor&&(localRefExtractor=getNativeByTNode),bindingsEnabled){var previousOrParentTNode=getPreviousOrParentTNode();getFirstTemplatePass()&&(ngDevMode&&ngDevMode.firstTemplatePass++,function(tView,viewData,directives,tNode,localRefs){ngDevMode&&assertEqual(getFirstTemplatePass(),!0,"should run on first template pass only");var exportsMap=localRefs?{"":-1}:null,totalHostVars=0;if(directives){initNodeFlags(tNode,tView.data.length,directives.length);for(var i=0;i<directives.length;i++){var def=directives[i];def.providersResolver&&def.providersResolver(def)}generateExpandoInstructionBlock(tView,tNode,directives.length);for(var i=0;i<directives.length;i++){var def=directives[i],directiveDefIdx=tView.data.length;baseResolveDirective(tView,viewData,def,def.factory),totalHostVars+=def.hostVars,saveNameToExportMap(tView.data.length-1,def,exportsMap),queueInitHooks(directiveDefIdx,def.onInit,def.doCheck,tView)}}exportsMap&&function(tNode,localRefs,exportsMap){if(localRefs)for(var localNames=tNode.localNames=[],i=0;i<localRefs.length;i+=2){var index=exportsMap[localRefs[i+1]];if(null==index)throw new Error("Export of name '"+localRefs[i+1]+"' not found!");localNames.push(localRefs[i],index)}}(tNode,localRefs,exportsMap);prefillHostVars(tView,viewData,totalHostVars)}(tView,viewData,function(tView,viewData,tNode){ngDevMode&&assertEqual(getFirstTemplatePass(),!0,"should run on first template pass only");var registry=tView.directiveRegistry,matches=null;if(registry)for(var i=0;i<registry.length;i++){var def=registry[i];isNodeMatchingSelectorList(tNode,def.selectors)&&(matches||(matches=[]),diPublicInInjector(getOrCreateNodeInjectorForNode(getPreviousOrParentTNode(),viewData),viewData,def.type),isComponentDef(def)?(4096&tNode.flags&&throwMultipleComponentError(tNode),tNode.flags=4096,matches.unshift(def)):matches.push(def))}return matches}(tView,viewData,previousOrParentTNode),previousOrParentTNode,localRefs||null)),function(tView,viewData,previousOrParentTNode){var start=previousOrParentTNode.flags>>16,end=start+previousOrParentTNode.flags&4095;!getFirstTemplatePass()&&start<end&&getOrCreateNodeInjectorForNode(previousOrParentTNode,viewData);for(var i=start;i<end;i++){var def=tView.data[i];isComponentDef(def)&&addComponentLogic(viewData,previousOrParentTNode,def);var directive=getNodeInjectable(tView.data,viewData,i,previousOrParentTNode);postProcessDirective(viewData,directive,def,i)}}(tView,viewData,previousOrParentTNode),function(viewData,tNode,localRefExtractor){var localNames=tNode.localNames;if(localNames)for(var localIndex=tNode.index+1,i=0;i<localNames.length;i+=2){var index=localNames[i+1],value=-1===index?localRefExtractor(tNode,viewData):viewData[index];viewData[localIndex++]=value}}(viewData,previousOrParentTNode,localRefExtractor)}}function getOrCreateTView(templateFn,consts,vars,directives,pipes,viewQuery){return templateFn.ngPrivateData||(templateFn.ngPrivateData=createTView(-1,templateFn,consts,vars,directives,pipes,viewQuery))}function createTView(viewIndex,templateFn,consts,vars,directives,pipes,viewQuery){ngDevMode&&ngDevMode.tView++;var bindingStartIndex=HEADER_OFFSET+consts,initialViewLength=bindingStartIndex+vars,blueprint=function(bindingStartIndex,initialViewLength){var blueprint=new Array(initialViewLength).fill(null,0,bindingStartIndex).fill(NO_CHANGE,bindingStartIndex);return blueprint[CONTAINER_INDEX]=-1,blueprint[BINDING_INDEX]=bindingStartIndex,blueprint}(bindingStartIndex,initialViewLength);return blueprint[TVIEW]={id:viewIndex,blueprint:blueprint,template:templateFn,viewQuery:viewQuery,node:null,data:blueprint.slice(),childIndex:-1,bindingStartIndex:bindingStartIndex,expandoStartIndex:initialViewLength,expandoInstructions:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,cleanup:null,contentQueries:null,components:null,directiveRegistry:"function"==typeof directives?directives():directives,pipeRegistry:"function"==typeof pipes?pipes():pipes,firstChild:null}}function setUpAttributes(native,attrs){for(var renderer=getRenderer(),isProc=isProceduralRenderer(renderer),i=0;i<attrs.length;){var attrName=attrs[i];if(1===attrName)break;if(attrName===NG_PROJECT_AS_ATTR_NAME)i+=2;else if(ngDevMode&&ngDevMode.rendererSetAttribute++,0===attrName){var namespaceURI=attrs[i+1],attrName_1=attrs[i+2],attrVal=attrs[i+3];isProc?renderer.setAttribute(native,attrName_1,attrVal,namespaceURI):native.setAttributeNS(namespaceURI,attrName_1,attrVal),i+=4}else{attrVal=attrs[i+1];isProc?renderer.setAttribute(native,attrName,attrVal):native.setAttribute(attrName,attrVal),i+=2}}}function createError(text,token){return new Error("Renderer: "+text+" ["+stringify$1(token)+"]")}function locateHostElement(factory,elementOrSelector){ngDevMode&&assertDataInRange(-1),function(factory){rendererFactory=factory}(factory);var defaultRenderer=factory.createRenderer(null,null),rNode="string"==typeof elementOrSelector?isProceduralRenderer(defaultRenderer)?defaultRenderer.selectRootElement(elementOrSelector):defaultRenderer.querySelector(elementOrSelector):elementOrSelector;if(ngDevMode&&!rNode)throw createError("string"==typeof elementOrSelector?"Host node with selector not found:":"Host node is required:",elementOrSelector);return rNode}function listener(eventName,listenerFn,useCapture){void 0===useCapture&&(useCapture=!1);var viewData=getViewData(),tNode=getPreviousOrParentTNode();if(ngDevMode&&assertNodeOfPossibleTypes(tNode,3,0,4),3===tNode.type){var native=getNativeByTNode(tNode,viewData);ngDevMode&&ngDevMode.rendererAddEventListener++;var renderer=getRenderer();if(isProceduralRenderer(renderer)){storeCleanupFn(viewData,renderer.listen(native,eventName,listenerFn))}else{var wrappedListener=function(listenerFn){return function(e){!1===listenerFn(e)&&(e.preventDefault(),e.returnValue=!1)}}(listenerFn);native.addEventListener(eventName,wrappedListener,useCapture);var cleanupInstances=getCleanup(viewData);cleanupInstances.push(wrappedListener),getFirstTemplatePass()&&getTViewCleanup(viewData).push(eventName,tNode.index,cleanupInstances.length-1,useCapture)}}void 0===tNode.outputs&&(tNode.outputs=generatePropertyAliases(tNode.flags,1));var outputData,outputs=tNode.outputs;outputs&&(outputData=outputs[eventName])&&function(viewData,outputs,listener){for(var i=0;i<outputs.length;i+=2){ngDevMode&&assertDataInRange(outputs[i],viewData);var subscription=viewData[outputs[i]][outputs[i+1]].subscribe(listener);storeCleanupWithContext(viewData,subscription,subscription.unsubscribe)}}(viewData,outputData,listenerFn)}function storeCleanupWithContext(view,context,cleanupFn){view||(view=getViewData()),getCleanup(view).push(context),view[TVIEW].firstTemplatePass&&getTViewCleanup(view).push(cleanupFn,view[CLEANUP].length-1)}function storeCleanupFn(view,cleanupFn){getCleanup(view).push(cleanupFn),view[TVIEW].firstTemplatePass&&getTViewCleanup(view).push(view[CLEANUP].length-1,null)}function elementEnd(){var previousOrParentTNode=getPreviousOrParentTNode();getIsParent()?setIsParent(!1):(ngDevMode&&assertHasParent(),setPreviousOrParentTNode(previousOrParentTNode=previousOrParentTNode.parent)),ngDevMode&&assertNodeType(previousOrParentTNode,3);var currentQueries=getCurrentQueries();currentQueries&&setCurrentQueries(currentQueries.addNode(previousOrParentTNode)),queueLifecycleHooks(previousOrParentTNode.flags,getTView()),elementDepthCount--}function elementAttribute(index,name,value,sanitizer){if(value!==NO_CHANGE){var viewData=getViewData(),renderer=getRenderer(),element_1=getNativeByIndex(index,viewData);if(null==value)ngDevMode&&ngDevMode.rendererRemoveAttribute++,isProceduralRenderer(renderer)?renderer.removeAttribute(element_1,name):element_1.removeAttribute(name);else{ngDevMode&&ngDevMode.rendererSetAttribute++;var strValue=null==sanitizer?stringify$1(value):sanitizer(value);isProceduralRenderer(renderer)?renderer.setAttribute(element_1,name,strValue):element_1.setAttribute(name,strValue)}}}function elementProperty(index,propName,value,sanitizer){if(value!==NO_CHANGE){var dataValue,viewData=getViewData(),element=getNativeByIndex(index,viewData),tNode=getTNode(index,viewData),inputData=initializeTNodeInputs(tNode);if(inputData&&(dataValue=inputData[propName]))setInputsForProperty(viewData,dataValue,value),isComponent(tNode)&&function(viewData,viewIndex){var view=getComponentViewByIndex(viewIndex,viewData);2&view[FLAGS]||(view[FLAGS]|=4)}(viewData,index+HEADER_OFFSET);else if(3===tNode.type){var renderer=getRenderer();value=null!=sanitizer?sanitizer(value):value,ngDevMode&&ngDevMode.rendererSetProperty++,isProceduralRenderer(renderer)?renderer.setProperty(element,propName,value):element.setProperty?element.setProperty(propName,value):element[propName]=value}}}function createTNode(viewData,type,adjustedIndex,tagName,attrs,tViews){var previousOrParentTNode=getPreviousOrParentTNode();ngDevMode&&ngDevMode.tNode++;var parent=getIsParent()?previousOrParentTNode:previousOrParentTNode&&previousOrParentTNode.parent,tParent=parent&&viewData&&parent!==viewData[HOST_NODE]?parent:null;return{type:type,index:adjustedIndex,injectorIndex:tParent?tParent.injectorIndex:-1,flags:0,providerIndexes:0,tagName:tagName,attrs:attrs,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,tViews:tViews,next:null,child:null,parent:tParent,detached:null,stylingTemplate:null,projection:null}}function setInputsForProperty(viewData,inputs,value){for(var i=0;i<inputs.length;i+=2)ngDevMode&&assertDataInRange(inputs[i],viewData),viewData[inputs[i]][inputs[i+1]]=value}function generatePropertyAliases(tNodeFlags,direction){var tView=getTView(),count=4095&tNodeFlags,propStore=null;if(count>0)for(var start=tNodeFlags>>16,end=start+count,isInput=0===direction,defs=tView.data,i=start;i<end;i++){var directiveDef=defs[i],propertyAliasMap=isInput?directiveDef.inputs:directiveDef.outputs;for(var publicName in propertyAliasMap)if(propertyAliasMap.hasOwnProperty(publicName)){propStore=propStore||{};var internalName=propertyAliasMap[publicName];propStore.hasOwnProperty(publicName)?propStore[publicName].push(i,internalName):propStore[publicName]=[i,internalName]}}return propStore}function elementClassProp(index,stylingIndex,value){var val=value instanceof BoundPlayerFactory?value:!!value;!function(context,index,addOrRemove){updateStyleProp(context,index+context[4],addOrRemove)}(getStylingContext(index,getViewData()),stylingIndex,val)}function elementStyling(classDeclarations,styleDeclarations,styleSanitizer){var tNode=getPreviousOrParentTNode(),inputData=initializeTNodeInputs(tNode);if(!tNode.stylingTemplate){var hasClassInput=!(!inputData||!inputData.hasOwnProperty("class"));hasClassInput&&(tNode.flags|=32768),tNode.stylingTemplate=function(initialClassDeclarations,initialStyleDeclarations,styleSanitizer,onlyProcessSingleClasses){var initialStylingValues=[null],context=createEmptyStylingContext(null,styleSanitizer,initialStylingValues),stylesLookup={},classesLookup={},totalStyleDeclarations=0;if(initialStyleDeclarations)for(var hasPassedDeclarations=!1,i=0;i<initialStyleDeclarations.length;i++)if(1===(v=initialStyleDeclarations[i]))hasPassedDeclarations=!0;else{var prop=v;if(hasPassedDeclarations){var value=initialStyleDeclarations[++i];initialStylingValues.push(value),stylesLookup[prop]=initialStylingValues.length-1}else totalStyleDeclarations++,stylesLookup[prop]=0}context[4]=totalStyleDeclarations;var initialStaticClasses=onlyProcessSingleClasses?[]:null;if(initialClassDeclarations)for(hasPassedDeclarations=!1,i=0;i<initialClassDeclarations.length;i++){var v;if(1===(v=initialClassDeclarations[i]))hasPassedDeclarations=!0;else{var className=v;hasPassedDeclarations?(value=initialClassDeclarations[++i],initialStylingValues.push(value),classesLookup[className]=initialStylingValues.length-1,initialStaticClasses&&initialStaticClasses.push(className)):classesLookup[className]=0}}var styleProps=Object.keys(stylesLookup),classNames=Object.keys(classesLookup),classNamesIndexStart=styleProps.length,totalProps=styleProps.length+classNames.length,maxLength=4*totalProps*2+8;for(i=8;i<maxLength;i++)context.push(null);var multiStart=4*totalProps+8;for(i=0;i<totalProps;i++){var isClassBased_1=i>=classNamesIndexStart,indexForInitial=(prop=isClassBased_1?classNames[i-classNamesIndexStart]:styleProps[i],isClassBased_1?classesLookup[prop]:stylesLookup[prop]),initialValue=initialStylingValues[indexForInitial],indexForMulti=4*i+multiStart,indexForSingle=4*i+8,initialFlag=prepareInitialFlag(prop,isClassBased_1,styleSanitizer||null);setFlag(context,indexForSingle,pointers(initialFlag,indexForInitial,indexForMulti)),setProp(context,indexForSingle,prop),setValue(context,indexForSingle,null),setPlayerBuilderIndex(context,indexForSingle,0),setFlag(context,indexForMulti,pointers(initialFlag|(null!==initialValue?1:0),indexForInitial,indexForSingle)),setProp(context,indexForMulti,prop),setValue(context,indexForMulti,null),setPlayerBuilderIndex(context,indexForMulti,0)}return setFlag(context,3,pointers(0,0,multiStart)|(onlyProcessSingleClasses?16:0)),setContextDirty(context,initialStylingValues.length>1),initialStaticClasses&&(context[6]=initialStaticClasses.join(" ")),context}(classDeclarations,styleDeclarations,styleSanitizer,hasClassInput)}if(styleDeclarations&&styleDeclarations.length||classDeclarations&&classDeclarations.length){var index=tNode.index-HEADER_OFFSET;if(delegateToClassInput(tNode)){var initialClasses=getStylingContext(index,getViewData())[6];setInputsForProperty(getViewData(),tNode.inputs.class,initialClasses)}elementStylingApply(index)}}function elementStylingApply(index){var viewData=getViewData(),isFirstRender=0!=(1&viewData[FLAGS]);renderStyleAndClassBindings(getStylingContext(index,viewData),getRenderer(),viewData,isFirstRender)>0&&scheduleTick(getRootContext$1(viewData),2)}function elementStyleProp(index,styleIndex,value,suffix){var valueToAdd=null;value&&(valueToAdd=suffix?stringify$1(value)+suffix:value),updateStyleProp(getStylingContext(index,getViewData()),styleIndex,valueToAdd)}function elementStylingMap(index,classes,styles){var viewData=getViewData(),tNode=getTNode(index,viewData),stylingContext=getStylingContext(index,viewData);if(delegateToClassInput(tNode)&&classes!==NO_CHANGE){var initialClasses=stylingContext[6],classInputVal=(initialClasses.length?initialClasses+" ":"")+classes;setInputsForProperty(getViewData(),tNode.inputs.class,classInputVal)}!function(context,classesInput,stylesInput){stylesInput=stylesInput||null;var element=context[5],classesPlayerBuilder=classesInput instanceof BoundPlayerFactory?new ClassAndStylePlayerBuilder(classesInput,element,1):null,stylesPlayerBuilder=stylesInput instanceof BoundPlayerFactory?new ClassAndStylePlayerBuilder(stylesInput,element,2):null,classesValue=classesPlayerBuilder?classesInput.value:classesInput,stylesValue=stylesPlayerBuilder?stylesInput.value:stylesInput,ignoreAllClassUpdates=limitToSingleClasses(context)||classesValue===NO_CHANGE||classesValue===context[6],ignoreAllStyleUpdates=stylesValue===NO_CHANGE||stylesValue===context[7];if(!ignoreAllClassUpdates||!ignoreAllStyleUpdates){context[6]=classesValue,context[7]=stylesValue;var classNames=EMPTY_ARR,applyAllClasses=!1,playerBuildersAreDirty=!1,classesPlayerBuilderIndex=classesPlayerBuilder?1:0;hasPlayerBuilderChanged(context,classesPlayerBuilder,1)&&(setPlayerBuilder(context,classesPlayerBuilder,1),playerBuildersAreDirty=!0);var stylesPlayerBuilderIndex=stylesPlayerBuilder?3:0;hasPlayerBuilderChanged(context,stylesPlayerBuilder,3)&&(setPlayerBuilder(context,stylesPlayerBuilder,3),playerBuildersAreDirty=!0),ignoreAllClassUpdates||("string"==typeof classesValue?(classNames=classesValue.split(/\s+/),applyAllClasses=!0):classNames=classesValue?Object.keys(classesValue):EMPTY_ARR);for(var classes=classesValue||EMPTY_OBJ$1,styleProps=stylesValue?Object.keys(stylesValue):EMPTY_ARR,styles=stylesValue||EMPTY_OBJ$1,classesStartIndex=styleProps.length,dirty=!1,ctxIndex=getMultiStartIndex(context),propIndex=0,propLimit=styleProps.length+classNames.length;ctxIndex<context.length&&propIndex<propLimit;){var isClassBased_2=propIndex>=classesStartIndex;if(!isClassBased_2&&!ignoreAllStyleUpdates||isClassBased_2&&!ignoreAllClassUpdates){var adjustedPropIndex=isClassBased_2?propIndex-classesStartIndex:propIndex,newProp=isClassBased_2?classNames[adjustedPropIndex]:styleProps[adjustedPropIndex],newValue=isClassBased_2?!!applyAllClasses||classes[newProp]:styles[newProp],playerBuilderIndex=isClassBased_2?classesPlayerBuilderIndex:stylesPlayerBuilderIndex;if((prop=getProp(context,ctxIndex))===newProp){var value=getValue(context,ctxIndex),flag=getPointers(context,ctxIndex);setPlayerBuilderIndex(context,ctxIndex,playerBuilderIndex),hasValueChanged(flag,value,newValue)&&(setValue(context,ctxIndex,newValue),playerBuildersAreDirty=playerBuildersAreDirty||!!playerBuilderIndex,hasValueChanged(flag,initialValue=getInitialValue(context,flag),newValue)&&(setDirty(context,ctxIndex,!0),dirty=!0))}else{var indexOfEntry=findEntryPositionByProp(context,newProp,ctxIndex);if(indexOfEntry>0){var valueToCompare=getValue(context,indexOfEntry),flagToCompare=getPointers(context,indexOfEntry);if(swapMultiContextEntries(context,ctxIndex,indexOfEntry),hasValueChanged(flagToCompare,valueToCompare,newValue)){var initialValue=getInitialValue(context,flagToCompare);setValue(context,ctxIndex,newValue),hasValueChanged(flagToCompare,initialValue,newValue)&&(setDirty(context,ctxIndex,!0),playerBuildersAreDirty=playerBuildersAreDirty||!!playerBuilderIndex,dirty=!0)}}else{var newFlag=prepareInitialFlag(newProp,isClassBased_2,getStyleSanitizer(context));playerBuildersAreDirty=playerBuildersAreDirty||!!playerBuilderIndex,insertNewMultiProperty(context,ctxIndex,isClassBased_2,newProp,newFlag,newValue,playerBuilderIndex),dirty=!0}}}ctxIndex+=4,propIndex++}for(;ctxIndex<context.length;){var isClassBased_3=2==(2&(flag=getPointers(context,ctxIndex)));(!isClassBased_3&&!ignoreAllStyleUpdates||isClassBased_3&&!ignoreAllClassUpdates)&&valueExists(value=getValue(context,ctxIndex),isClassBased_3)&&(setDirty(context,ctxIndex,!0),setValue(context,ctxIndex,null),setPlayerBuilderIndex(context,ctxIndex,playerBuilderIndex=isClassBased_3?classesPlayerBuilderIndex:stylesPlayerBuilderIndex),dirty=!0),ctxIndex+=4}for(var sanitizer=getStyleSanitizer(context);propIndex<propLimit;){var isClassBased_4=propIndex>=classesStartIndex;if(!isClassBased_4&&!ignoreAllStyleUpdates||isClassBased_4&&!ignoreAllClassUpdates){adjustedPropIndex=isClassBased_4?propIndex-classesStartIndex:propIndex;var prop=isClassBased_4?classNames[adjustedPropIndex]:styleProps[adjustedPropIndex];value=isClassBased_4?!!applyAllClasses||classes[prop]:styles[prop],flag=1|prepareInitialFlag(prop,isClassBased_4,sanitizer),playerBuilderIndex=isClassBased_4?classesPlayerBuilderIndex:stylesPlayerBuilderIndex,context.push(flag,prop,value,playerBuilderIndex),dirty=!0}propIndex++}dirty&&setContextDirty(context,!0),playerBuildersAreDirty&&setContextPlayersDirty(context,!0)}}(stylingContext,classes,styles)}function text(index,value){var viewData=getViewData();ngDevMode&&assertEqual(viewData[BINDING_INDEX],getTView().bindingStartIndex,"text nodes should be created before any bindings"),ngDevMode&&ngDevMode.rendererCreateTextNode++;var textNative=createTextNode(value,getRenderer()),tNode=createNodeAtIndex(index,3,textNative,null,null);setIsParent(!1),appendChild(textNative,tNode,viewData)}function textBinding(index,value){if(value!==NO_CHANGE){ngDevMode&&assertDataInRange(index+HEADER_OFFSET);var element_2=getNativeByIndex(index,getViewData());ngDevMode&&assertDefined(element_2,"native element should exist"),ngDevMode&&ngDevMode.rendererSetText++;var renderer=getRenderer();isProceduralRenderer(renderer)?renderer.setValue(element_2,stringify$1(value)):element_2.textContent=stringify$1(value)}}function generateExpandoInstructionBlock(tView,tNode,directiveCount){ngDevMode&&assertEqual(tView.firstTemplatePass,!0,"Expando block should only be generated on first template pass.");var elementIndex=-(tNode.index-HEADER_OFFSET),providerStartIndex=65535&tNode.providerIndexes,providerCount=tView.data.length-providerStartIndex;(tView.expandoInstructions||(tView.expandoInstructions=[])).push(elementIndex,providerCount,directiveCount)}function prefillHostVars(tView,viewData,totalHostVars){for(var i=0;i<totalHostVars;i++)viewData.push(NO_CHANGE),tView.blueprint.push(NO_CHANGE),tView.data.push(null)}function postProcessDirective(viewData,directive,def,directiveDefIdx){var previousOrParentTNode=getPreviousOrParentTNode();(postProcessBaseDirective(viewData,previousOrParentTNode,directive,def),ngDevMode&&assertDefined(previousOrParentTNode,"previousOrParentTNode"),previousOrParentTNode&&previousOrParentTNode.attrs&&function(directiveIndex,instance,inputs,tNode){var initialInputData=tNode.initialInputs;(void 0===initialInputData||directiveIndex>=initialInputData.length)&&(initialInputData=function(directiveIndex,inputs,tNode){var initialInputData=tNode.initialInputs||(tNode.initialInputs=[]);initialInputData[directiveIndex]=null;var attrs=tNode.attrs,i=0;for(;i<attrs.length;){var attrName=attrs[i];if(1===attrName)break;if(0!==attrName){var minifiedInputName=inputs[attrName],attrValue=attrs[i+1];if(void 0!==minifiedInputName){var inputsToStore=initialInputData[directiveIndex]||(initialInputData[directiveIndex]=[]);inputsToStore.push(minifiedInputName,attrValue)}i+=2}else i+=4}return initialInputData}(directiveIndex,inputs,tNode));var initialInputs=initialInputData[directiveIndex];if(initialInputs)for(var i=0;i<initialInputs.length;i+=2)instance[initialInputs[i]]=initialInputs[i+1]}(directiveDefIdx,directive,def.inputs,previousOrParentTNode),def.contentQueries&&def.contentQueries(directiveDefIdx),isComponentDef(def))&&(getComponentViewByIndex(previousOrParentTNode.index,viewData)[CONTEXT]=directive)}function postProcessBaseDirective(viewData,previousOrParentTNode,directive,def){var native=getNativeByTNode(previousOrParentTNode,viewData);ngDevMode&&assertEqual(viewData[BINDING_INDEX],getTView().bindingStartIndex,"directives should be created before any bindings"),ngDevMode&&assertPreviousIsParent(),attachPatchData(directive,viewData),native&&attachPatchData(native,viewData),null!=def.attributes&&3==previousOrParentTNode.type&&setUpAttributes(native,def.attributes)}function queueComponentIndexForCheck(previousOrParentTNode){ngDevMode&&assertEqual(getFirstTemplatePass(),!0,"Should only be called in first template pass.");var tView=getTView();(tView.components||(tView.components=[])).push(previousOrParentTNode.index)}function saveNameToExportMap(index,def,exportsMap){exportsMap&&(def.exportAs&&(exportsMap[def.exportAs]=index),def.template&&(exportsMap[""]=index))}function initNodeFlags(tNode,index,numberOfDirectives){ngDevMode&&assertEqual(getFirstTemplatePass(),!0,"expected firstTemplatePass to be true");var flags=tNode.flags;ngDevMode&&assertEqual(0===flags||4096===flags,!0,"expected node flags to not be initialized"),ngDevMode&&assertNotEqual(numberOfDirectives,4095,"Reached the max number of directives"),tNode.flags=index<<16|4096&flags|numberOfDirectives,tNode.providerIndexes=index}function baseResolveDirective(tView,viewData,def,directiveFactory){tView.data.push(def);var nodeInjectorFactory=new NodeInjectorFactory(directiveFactory,isComponentDef(def),null);tView.blueprint.push(nodeInjectorFactory),viewData.push(nodeInjectorFactory),function(tView,def){ngDevMode&&assertEqual(getFirstTemplatePass(),!0,"Should only be called in first template pass."),tView.expandoInstructions.push(def.hostBindings||noop),def.hostVars&&tView.expandoInstructions.push(def.hostVars)}(tView,def)}function addComponentLogic(viewData,previousOrParentTNode,def){var native=getNativeByTNode(previousOrParentTNode,viewData),tView=getOrCreateTView(def.template,def.consts,def.vars,def.directiveDefs,def.pipeDefs,def.viewQuery),componentView=addToViewTree(viewData,previousOrParentTNode.index,createLViewData(getRendererFactory().createRenderer(native,def),tView,null,def.onPush?4:2,getCurrentSanitizer()));componentView[HOST_NODE]=previousOrParentTNode,componentView[HOST]=viewData[previousOrParentTNode.index],viewData[previousOrParentTNode.index]=componentView,getFirstTemplatePass()&&queueComponentIndexForCheck(previousOrParentTNode)}function createLContainer(hostNative,hostTNode,currentView,native,isForViewContainerRef){return[isForViewContainerRef?-1:0,[],currentView,null,null,hostNative,native,getRenderParent(hostTNode,currentView)]}function template(index,templateFn,consts,vars,tagName,attrs,localRefs,localRefExtractor){var viewData=getViewData(),tView=getTView(),tNode=containerInternal(index,tagName||null,attrs||null);getFirstTemplatePass()&&(tNode.tViews=createTView(-1,templateFn,consts,vars,tView.directiveRegistry,tView.pipeRegistry,null)),createDirectivesAndLocals(tView,viewData,localRefs,localRefExtractor);var currentQueries=getCurrentQueries(),previousOrParentTNode=getPreviousOrParentTNode();currentQueries&&setCurrentQueries(currentQueries.addNode(previousOrParentTNode)),queueLifecycleHooks(tNode.flags,tView),setIsParent(!1)}function container(index){var tNode=containerInternal(index,null,null);getFirstTemplatePass()&&(tNode.tViews=[]),setIsParent(!1)}function containerInternal(index,tagName,attrs){var viewData=getViewData();ngDevMode&&assertEqual(viewData[BINDING_INDEX],getTView().bindingStartIndex,"container nodes should be created before any bindings");var adjustedIndex=index+HEADER_OFFSET,comment=getRenderer().createComment(ngDevMode?"container":"");ngDevMode&&ngDevMode.rendererCreateComment++;var tNode=createNodeAtIndex(index,0,comment,tagName,attrs),lContainer=viewData[adjustedIndex]=createLContainer(viewData[adjustedIndex],tNode,viewData,comment);appendChild(comment,tNode,viewData),addToViewTree(viewData,index+HEADER_OFFSET,lContainer);var currentQueries=getCurrentQueries();return currentQueries&&(lContainer[QUERIES]=currentQueries.container()),ngDevMode&&assertNodeType(getPreviousOrParentTNode(),0),tNode}function containerRefreshStart(index){var viewData=getViewData(),tView=getTView(),previousOrParentTNode=loadInternal(index,tView.data);setPreviousOrParentTNode(previousOrParentTNode),ngDevMode&&assertNodeType(previousOrParentTNode,0),setIsParent(!0),viewData[index+HEADER_OFFSET][ACTIVE_INDEX]=0,getCheckNoChangesMode()||executeInitHooks(viewData,tView,getCreationMode())}function containerRefreshEnd(){var previousOrParentTNode=getPreviousOrParentTNode();getIsParent()?setIsParent(!1):(ngDevMode&&assertNodeType(previousOrParentTNode,2),ngDevMode&&assertHasParent(),setPreviousOrParentTNode(previousOrParentTNode=previousOrParentTNode.parent)),ngDevMode&&assertNodeType(previousOrParentTNode,0);for(var lContainer=getViewData()[previousOrParentTNode.index],nextIndex=lContainer[ACTIVE_INDEX];nextIndex<lContainer[VIEWS].length;)removeView(lContainer,previousOrParentTNode,nextIndex)}function embeddedViewStart(viewBlockId,consts,vars){var viewData=getViewData(),previousOrParentTNode=getPreviousOrParentTNode(),containerTNode=2===previousOrParentTNode.type?previousOrParentTNode.parent:previousOrParentTNode,lContainer=viewData[containerTNode.index];ngDevMode&&assertNodeType(containerTNode,0);var viewToRender=function(lContainer,tContainerNode,startIdx,viewBlockId){for(var views=lContainer[VIEWS],i=startIdx;i<views.length;i++){var viewAtPositionId=views[i][TVIEW].id;if(viewAtPositionId===viewBlockId)return views[i];if(!(viewAtPositionId<viewBlockId))break;removeView(lContainer,tContainerNode,i)}return null}(lContainer,containerTNode,lContainer[ACTIVE_INDEX],viewBlockId);return viewToRender?(setIsParent(!0),enterView(viewToRender,viewToRender[TVIEW].node)):(viewToRender=createLViewData(getRenderer(),function(viewIndex,consts,vars,parent){var tView=getTView();ngDevMode&&assertNodeType(parent,0);var containerTViews=parent.tViews;ngDevMode&&assertDefined(containerTViews,"TView expected"),ngDevMode&&assertEqual(Array.isArray(containerTViews),!0,"TViews should be in an array"),(viewIndex>=containerTViews.length||null==containerTViews[viewIndex])&&(containerTViews[viewIndex]=createTView(viewIndex,null,consts,vars,tView.directiveRegistry,tView.pipeRegistry,null));return containerTViews[viewIndex]}(viewBlockId,consts,vars,containerTNode),null,2,getCurrentSanitizer()),lContainer[QUERIES]&&(viewToRender[QUERIES]=lContainer[QUERIES].createView()),createViewNode(viewBlockId,viewToRender),enterView(viewToRender,viewToRender[TVIEW].node)),lContainer&&(getCreationMode()&&insertView(viewToRender,lContainer,viewData,lContainer[ACTIVE_INDEX],-1),lContainer[ACTIVE_INDEX]++),getRenderFlags(viewToRender)}function embeddedViewEnd(){var viewData=getViewData(),viewHost=viewData[HOST_NODE];refreshDescendantViews(viewData,null),leaveView(viewData[PARENT]),setPreviousOrParentTNode(viewHost),setIsParent(!1)}function componentRefresh(adjustedElementIndex,parentFirstTemplatePass,rf){ngDevMode&&assertDataInRange(adjustedElementIndex);var hostView=getComponentViewByIndex(adjustedElementIndex,getViewData());ngDevMode&&assertNodeType(getTView().data[adjustedElementIndex],3),viewAttached(hostView)&&6&hostView[FLAGS]&&(parentFirstTemplatePass&&function(componentView){for(var componentTView=componentView[TVIEW],i=componentView.length;i<componentTView.blueprint.length;i++)componentView[i]=componentTView.blueprint[i]}(hostView),detectChangesInternal(hostView,hostView[CONTEXT],rf))}function viewAttached(view){return 8==(8&view[FLAGS])}function projectionDef(selectors,textSelectors){var componentNode=findComponentView(getViewData())[HOST_NODE];if(!componentNode.projection)for(var noOfNodeBuckets=selectors?selectors.length+1:1,pData=componentNode.projection=new Array(noOfNodeBuckets).fill(null),tails=pData.slice(),componentChild=componentNode.child;null!==componentChild;){var bucketIndex=selectors?matchingSelectorIndex(componentChild,selectors,textSelectors):0,nextNode=componentChild.next;tails[bucketIndex]?tails[bucketIndex].next=componentChild:(pData[bucketIndex]=componentChild,componentChild.next=null),tails[bucketIndex]=componentChild,componentChild=nextNode}}var projectionNodeStack=[];function projection(nodeIndex,selectorIndex,attrs){void 0===selectorIndex&&(selectorIndex=0);var viewData=getViewData(),tProjectionNode=createNodeAtIndex(nodeIndex,1,null,null,attrs||null);null===tProjectionNode.projection&&(tProjectionNode.projection=selectorIndex),setIsParent(!1);for(var componentView=findComponentView(viewData),nodeToProject=componentView[HOST_NODE].projection[selectorIndex],projectedView=componentView[PARENT],projectionNodeIndex=-1;nodeToProject;){if(1===nodeToProject.type){var currentComponentView=findComponentView(projectedView),firstProjectedNode=currentComponentView[HOST_NODE].projection[nodeToProject.projection];if(firstProjectedNode){projectionNodeStack[++projectionNodeIndex]=nodeToProject,projectionNodeStack[++projectionNodeIndex]=projectedView,nodeToProject=firstProjectedNode,projectedView=currentComponentView[PARENT];continue}}else nodeToProject.flags|=8192,appendProjectedNode(nodeToProject,tProjectionNode,viewData,projectedView);null===nodeToProject.next&&projectedView!==componentView[PARENT]&&(projectedView=projectionNodeStack[projectionNodeIndex--],nodeToProject=projectionNodeStack[projectionNodeIndex--]),nodeToProject=nodeToProject.next}}function addToViewTree(currentView,adjustedHostIndex,state){var tView=getTView(),firstTemplatePass=getFirstTemplatePass();return currentView[TAIL]?currentView[TAIL][NEXT]=state:firstTemplatePass&&(tView.childIndex=adjustedHostIndex),currentView[TAIL]=state,state}function markViewDirty(view){for(var currentView=view;currentView&&!(64&currentView[FLAGS]);)currentView[FLAGS]|=4,currentView=currentView[PARENT];currentView[FLAGS]|=4,ngDevMode&&assertDefined(currentView[CONTEXT],"rootContext should be defined"),scheduleTick(currentView[CONTEXT],1)}function scheduleTick(rootContext,flags){var nothingScheduled=0===rootContext.flags;if(rootContext.flags|=flags,nothingScheduled&&rootContext.clean==_CLEAN_PROMISE){var res_1=void 0;rootContext.clean=new Promise(function(r){return res_1=r}),rootContext.scheduler(function(){if(1&rootContext.flags&&(rootContext.flags&=-2,tickRootContext(rootContext)),2&rootContext.flags){rootContext.flags&=-3;var playerHandler=rootContext.playerHandler;playerHandler&&playerHandler.flushPlayers()}rootContext.clean=_CLEAN_PROMISE,res_1(null)})}}function tickRootContext(rootContext){for(var i=0;i<rootContext.components.length;i++){var rootComponent=rootContext.components[i];renderComponentOrTemplate(readPatchedLViewData(rootComponent),rootComponent,2)}}function detectChanges(component){detectChangesInternal(getComponentViewByInstance(component),component,null)}function detectChangesInRootView(lViewData){tickRootContext(lViewData[CONTEXT])}function detectChangesInternal(hostView,component,rf){var hostTView=hostView[TVIEW],oldView=enterView(hostView,hostView[HOST_NODE]),templateFn=hostTView.template,viewQuery=hostTView.viewQuery;try{namespaceHTML(),function(viewQuery,renderFlags,viewFlags,component){viewQuery&&(1===renderFlags||null===renderFlags&&1&viewFlags)&&viewQuery(1,component)}(viewQuery,rf,hostView[FLAGS],component),templateFn(rf||getRenderFlags(hostView),component),refreshDescendantViews(hostView,rf),function(viewQuery,flags,component){viewQuery&&2&flags&&viewQuery(2,component)}(viewQuery,hostView[FLAGS],component)}finally{leaveView(oldView,1===rf)}}function bind(value){return bindingUpdated(getViewData()[BINDING_INDEX]++,value)?value:NO_CHANGE}function interpolationV(values){ngDevMode&&assertLessThan(2,values.length,"should have at least 3 values"),ngDevMode&&assertEqual(values.length%2,1,"should have an odd number of values");for(var different=!1,i=1;i<values.length;i+=2)bindingUpdated(getViewData()[BINDING_INDEX]++,values[i])&&(different=!0);if(!different)return NO_CHANGE;var content=values[0];for(i=1;i<values.length;i+=2)content+=stringify$1(values[i])+values[i+1];return content}function interpolation1(prefix,v0,suffix){return bindingUpdated(getViewData()[BINDING_INDEX]++,v0)?prefix+stringify$1(v0)+suffix:NO_CHANGE}function interpolation2(prefix,v0,i0,v1,suffix){var viewData=getViewData(),different=bindingUpdated2(viewData[BINDING_INDEX],v0,v1);return viewData[BINDING_INDEX]+=2,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+suffix:NO_CHANGE}function interpolation3(prefix,v0,i0,v1,i1,v2,suffix){var viewData=getViewData(),different=bindingUpdated3(viewData[BINDING_INDEX],v0,v1,v2);return viewData[BINDING_INDEX]+=3,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+suffix:NO_CHANGE}function interpolation4(prefix,v0,i0,v1,i1,v2,i2,v3,suffix){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return viewData[BINDING_INDEX]+=4,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+suffix:NO_CHANGE}function interpolation5(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,suffix){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated(viewData[BINDING_INDEX]+4,v4)||different,viewData[BINDING_INDEX]+=5,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+suffix:NO_CHANGE}function interpolation6(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,suffix){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated2(viewData[BINDING_INDEX]+4,v4,v5)||different,viewData[BINDING_INDEX]+=6,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+suffix:NO_CHANGE}function interpolation7(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,suffix){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated3(viewData[BINDING_INDEX]+4,v4,v5,v6)||different,viewData[BINDING_INDEX]+=7,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+suffix:NO_CHANGE}function interpolation8(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,i6,v7,suffix){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated4(viewData[BINDING_INDEX]+4,v4,v5,v6,v7)||different,viewData[BINDING_INDEX]+=8,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+i6+stringify$1(v7)+suffix:NO_CHANGE}function store(index,value){var tView=getTView(),adjustedIndex=index+HEADER_OFFSET;adjustedIndex>=tView.data.length&&(tView.data[adjustedIndex]=null),getViewData()[adjustedIndex]=value}function reference(index){return loadInternal(index,getContextViewData())}function loadQueryList(queryListIdx){var viewData=getViewData();return ngDevMode&&assertDefined(viewData[CONTENT_QUERIES],"Content QueryList array should be defined if reading a query."),ngDevMode&&assertDataInRange(queryListIdx,viewData[CONTENT_QUERIES]),viewData[CONTENT_QUERIES][queryListIdx]}function load(index){return loadInternal(index,getViewData())}function getBinding(bindingIndex){var viewData=getViewData();return ngDevMode&&assertDataInRange(viewData[bindingIndex]),ngDevMode&&assertNotEqual(viewData[bindingIndex],NO_CHANGE,"Stored value should never be NO_CHANGE."),viewData[bindingIndex]}function bindingUpdated(bindingIndex,value){var viewData=getViewData(),checkNoChangesMode=getCheckNoChangesMode();if(ngDevMode&&assertNotEqual(value,NO_CHANGE,"Incoming value should never be NO_CHANGE."),ngDevMode&&assertLessThan(bindingIndex,viewData.length,"Slot should have been initialized to NO_CHANGE"),viewData[bindingIndex]===NO_CHANGE)viewData[bindingIndex]=value;else{if(!
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(a,b,checkNoChangesMode){return ngDevMode&&checkNoChangesMode?!devModeEqual(a,b):!(a!=a&&b!=b)&&a!==b}(viewData[bindingIndex],value,checkNoChangesMode))return!1;!function(creationMode,checkNoChangesMode,oldValue,currValue){if(checkNoChangesMode){var msg="ExpressionChangedAfterItHasBeenCheckedError: Expression has changed after it was checked. Previous value: '"+oldValue+"'. Current value: '"+currValue+"'.";throw creationMode&&(msg+=" It seems like the view has been created after its parent and its children have been dirty checked. Has it been created in a change detection hook ?"),new Error(msg)}}(getCreationMode(),checkNoChangesMode,viewData[bindingIndex],value),viewData[bindingIndex]=value}return!0}function updateBinding(bindingIndex,value){return getViewData()[bindingIndex]=value}function bindingUpdated2(bindingIndex,exp1,exp2){var different=bindingUpdated(bindingIndex,exp1);return bindingUpdated(bindingIndex+1,exp2)||different}function bindingUpdated3(bindingIndex,exp1,exp2,exp3){var different=bindingUpdated2(bindingIndex,exp1,exp2);return bindingUpdated(bindingIndex+2,exp3)||different}function bindingUpdated4(bindingIndex,exp1,exp2,exp3,exp4){var different=bindingUpdated2(bindingIndex,exp1,exp2);return bindingUpdated2(bindingIndex+2,exp3,exp4)||different}function directiveInject(token,flags){return void 0===flags&&(flags=0),getOrCreateInjectable(getPreviousOrParentTNode(),getViewData(),token,flags)}function injectAttribute(attrNameToInject){return injectAttributeImpl(getPreviousOrParentTNode(),attrNameToInject)}function registerContentQuery(queryList,currentDirectiveIndex){var viewData=getViewData(),tView=getTView(),savedContentQueriesLength=(viewData[CONTENT_QUERIES]||(viewData[CONTENT_QUERIES]=[])).push(queryList);if(getFirstTemplatePass()){var tViewContentQueries=tView.contentQueries||(tView.contentQueries=[]);currentDirectiveIndex!==(tView.contentQueries.length?tView.contentQueries[tView.contentQueries.length-2]:-1)&&tViewContentQueries.push(currentDirectiveIndex,savedContentQueriesLength-1)}}var CLEAN_PROMISE=_CLEAN_PROMISE;function initializeTNodeInputs(tNode){return tNode?(void 0===tNode.inputs&&(tNode.inputs=generatePropertyAliases(tNode.flags,0)),tNode.inputs):null}function delegateToClassInput(tNode){return 32768&tNode.flags}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var R3ElementRef,R3TemplateRef,R3ViewContainerRef,NgModuleRef=function(){return function(){}}(),NgModuleFactory=function(){return function(){}}(),ViewRef=function(){function ViewRef(_view,_context,_componentIndex){this._context=_context,this._componentIndex=_componentIndex,this._appRef=null,this._viewContainerRef=null,this._tViewNode=null,this._view=_view}return Object.defineProperty(ViewRef.prototype,"context",{get:function(){return this._context?this._context:this._lookUpContext()},enumerable:!0,configurable:!0}),Object.defineProperty(ViewRef.prototype,"destroyed",{get:function(){return 32==(32&this._view[FLAGS])},enumerable:!0,configurable:!0}),ViewRef.prototype.destroy=function(){this._viewContainerRef&&viewAttached(this._view)&&(this._viewContainerRef.detach(this._viewContainerRef.indexOf(this)),this._viewContainerRef=null),destroyLView(this._view)},ViewRef.prototype.onDestroy=function(callback){storeCleanupFn(this._view,callback)},ViewRef.prototype.markForCheck=function(){markViewDirty(this._view)},ViewRef.prototype.detach=function(){this._view[FLAGS]&=-9},ViewRef.prototype.reattach=function(){this._view[FLAGS]|=8},ViewRef.prototype.detectChanges=function(){var rendererFactory=getRendererFactory();rendererFactory.begin&&rendererFactory.begin(),detectChanges(this.context),rendererFactory.end&&rendererFactory.end()},ViewRef.prototype.checkNoChanges=function(){!function(component){setCheckNoChangesMode(!0);try{detectChanges(component)}finally{setCheckNoChangesMode(!1)}}(this.context)},ViewRef.prototype.attachToViewContainerRef=function(vcRef){this._viewContainerRef=vcRef},ViewRef.prototype.detachFromAppRef=function(){this._appRef=null},ViewRef.prototype.attachToAppRef=function(appRef){this._appRef=appRef},ViewRef.prototype._lookUpContext=function(){return this._context=this._view[PARENT][this._componentIndex]},ViewRef}(),RootViewRef=function(_super){function RootViewRef(_view){var _this=_super.call(this,_view,null,-1)||this;return _this._view=_view,_this}return __extends(RootViewRef,_super),RootViewRef.prototype.detectChanges=function(){detectChangesInRootView(this._view)},RootViewRef.prototype.checkNoChanges=function(){!function(lViewData){setCheckNoChangesMode(!0);try{detectChangesInRootView(lViewData)}finally{setCheckNoChangesMode(!1)}}(this._view)},RootViewRef}(ViewRef);function createElementRef(ElementRefToken,tNode,view){return R3ElementRef||(R3ElementRef=function(_super){function ElementRef_(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(ElementRef_,_super),ElementRef_}(ElementRefToken)),new R3ElementRef(getNativeByTNode(tNode,view))}function createTemplateRef(TemplateRefToken,ElementRefToken,hostTNode,hostView){if(R3TemplateRef||(R3TemplateRef=function(_super){function TemplateRef_(_declarationParentView,elementRef,_tView,_renderer,_queries,_injectorIndex){var _this=_super.call(this)||this;return _this._declarationParentView=_declarationParentView,_this.elementRef=elementRef,_this._tView=_tView,_this._renderer=_renderer,_this._queries=_queries,_this._injectorIndex=_injectorIndex,_this}return __extends(TemplateRef_,_super),TemplateRef_.prototype.createEmbeddedView=function(context,container$$1,hostTNode,hostView,index){var lView=function(tView,context,declarationView,renderer,queries,injectorIndex){var _isParent=getIsParent(),_previousOrParentTNode=getPreviousOrParentTNode();setIsParent(!0),setPreviousOrParentTNode(null);var lView=createLViewData(renderer,tView,context,2,getCurrentSanitizer());return lView[DECLARATION_VIEW]=declarationView,queries&&(lView[QUERIES]=queries.createView()),createViewNode(-1,lView),tView.firstTemplatePass&&(tView.node.injectorIndex=injectorIndex),setIsParent(_isParent),setPreviousOrParentTNode(_previousOrParentTNode),lView}(this._tView,context,this._declarationParentView,this._renderer,this._queries,this._injectorIndex);container$$1&&insertView(lView,container$$1,hostView,index,hostTNode.index),renderEmbeddedTemplate(lView,this._tView,context,1);var viewRef=new ViewRef(lView,context,-1);return viewRef._tViewNode=lView[HOST_NODE],viewRef},TemplateRef_}(TemplateRefToken)),0===hostTNode.type){var hostContainer=hostView[hostTNode.index];return ngDevMode&&assertDefined(hostTNode.tViews,"TView must be allocated"),new R3TemplateRef(hostView,createElementRef(ElementRefToken,hostTNode,hostView),hostTNode.tViews,getRenderer(),hostContainer[QUERIES],hostTNode.injectorIndex)}return null}var NodeInjector$1=function(){function NodeInjector$$1(_tNode,_hostView){this._tNode=_tNode,this._hostView=_hostView}return NodeInjector$$1.prototype.get=function(token,notFoundValue){return getOrCreateInjectable(this._tNode,this._hostView,token,notFoundValue)},NodeInjector$$1}();function createViewRef(hostTNode,hostView,context){if(isComponent(hostTNode)){var componentIndex=hostTNode.flags>>16,componentView=getComponentViewByIndex(hostTNode.index,hostView);return new ViewRef(componentView,context,componentIndex)}if(3===hostTNode.type){var hostComponentView=findComponentView(hostView);return new ViewRef(hostComponentView,hostComponentView[CONTEXT],-1)}return null}function getComponent(target){var context=loadContext(target);if(void 0===context.component){for(var lViewData=context.lViewData;lViewData;){var ctx=lViewData[CONTEXT];if(ctx&&isComponentInstance(ctx)){context.component=ctx;break}lViewData=64&lViewData[FLAGS]?null:lViewData[PARENT]}void 0===context.component&&(context.component=null)}return context.component}function getHostComponent(target){var context=loadContext(target);return 4096&context.lViewData[TVIEW].data[context.nodeIndex].flags?getComponentViewByIndex(context.nodeIndex,context.lViewData)[CONTEXT]:null}function getRootContext$2(target){return function(componentOrView){var lViewData;Array.isArray(componentOrView)?(ngDevMode&&assertDefined(componentOrView,"lViewData"),lViewData=componentOrView):(ngDevMode&&assertDefined(componentOrView,"component"),lViewData=readPatchedLViewData(componentOrView));for(;lViewData&&!(64&lViewData[FLAGS]);)lViewData=lViewData[PARENT];return lViewData}(Array.isArray(target)?target:loadContext(target).lViewData)[CONTEXT]}function getRootComponents(target){return getRootContext$2(target).components.slice()}function getInjector(target){var context=loadContext(target),tNode=context.lViewData[TVIEW].data[context.nodeIndex];return new NodeInjector$1(tNode,context.lViewData)}function getDirectives(target){var context=loadContext(target);return void 0===context.directives&&(context.directives=discoverDirectives(context.nodeIndex,context.lViewData,!1)),context.directives||[]}function loadContext(target){var context=getContext(target);if(!context)throw new Error(ngDevMode?"Unable to find the given context data for the given target":"Invalid ng target");return context}function getLocalRefs(target){var context=loadContext(target);return void 0===context.localRefs&&(context.localRefs=function(lViewData,nodeIndex){var tNode=lViewData[TVIEW].data[nodeIndex];if(tNode&&tNode.localNames){for(var result={},i=0;i<tNode.localNames.length;i+=2){var localRefName=tNode.localNames[i],directiveIndex=tNode.localNames[i+1];result[localRefName]=-1===directiveIndex?getNativeByTNode(tNode,lViewData):lViewData[directiveIndex]}return result}return null}(context.lViewData,context.nodeIndex)),context.localRefs||{}}var GLOBAL_PUBLISH_EXPANDO_KEY="ng",_published=!1;function publishDefaultGlobalUtils(){_published||(_published=!0,publishGlobalUtil("getComponent",getComponent),publishGlobalUtil("getHostComponent",getHostComponent),publishGlobalUtil("getInjector",getInjector),publishGlobalUtil("getRootComponents",getRootComponents),publishGlobalUtil("getDirectives",getDirectives))}function publishGlobalUtil(name,fn){var w=_global;if(w){var container=w[GLOBAL_PUBLISH_EXPANDO_KEY];container||(container=w[GLOBAL_PUBLISH_EXPANDO_KEY]={}),container[name]=fn}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function createRootComponentView(rNode,def,rootView,renderer,sanitizer){resetComponentState();var tView=rootView[TVIEW],componentView=createLViewData(renderer,getOrCreateTView(def.template,def.consts,def.vars,def.directiveDefs,def.pipeDefs,def.viewQuery),null,def.onPush?4:2,sanitizer),tNode=createNodeAtIndex(0,3,rNode,null,null);return tView.firstTemplatePass&&(diPublicInInjector(getOrCreateNodeInjectorForNode(tNode,rootView),rootView,def.type),tNode.flags=4096,initNodeFlags(tNode,rootView.length,1),queueComponentIndexForCheck(tNode)),componentView[HOST]=rootView[HEADER_OFFSET],componentView[HOST_NODE]=tNode,rootView[HEADER_OFFSET]=componentView}function createRootComponent(componentView,componentDef,rootView,rootContext,hostFeatures){var tView=rootView[TVIEW],component=function(tView,viewData,def){var rootTNode=getPreviousOrParentTNode();tView.firstTemplatePass&&(def.providersResolver&&def.providersResolver(def),generateExpandoInstructionBlock(tView,rootTNode,1),baseResolveDirective(tView,viewData,def,def.factory));var directive=getNodeInjectable(tView.data,viewData,viewData.length-1,rootTNode);return postProcessBaseDirective(viewData,rootTNode,directive,def),directive}(tView,rootView,componentDef);return rootContext.components.push(component),componentView[CONTEXT]=component,hostFeatures&&hostFeatures.forEach(function(feature){return feature(component,componentDef)}),tView.firstTemplatePass&&prefillHostVars(tView,rootView,componentDef.hostVars),component}function createRootContext(scheduler,playerHandler){return{components:[],scheduler:scheduler||defaultScheduler,clean:CLEAN_PROMISE,playerHandler:playerHandler||null,flags:0}}function LifecycleHooksFeature(component,def){var rootTView=readPatchedLViewData(component)[TVIEW],dirIndex=rootTView.data.length-1;queueInitHooks(dirIndex,def.onInit,def.doCheck,rootTView),queueLifecycleHooks(dirIndex<<16|1,rootTView)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function getNullInjector(){return void 0===NULL_INJECTOR$2&&(NULL_INJECTOR$2=new NullInjector),NULL_INJECTOR$2}function createInjector(defType,parent,additionalProviders){return void 0===parent&&(parent=null),void 0===additionalProviders&&(additionalProviders=null),parent=parent||getNullInjector(),new R3Injector(defType,additionalProviders,parent)}var R3Injector=function(){function R3Injector(def,additionalProviders,parent){var _this=this;this.parent=parent,this.records=new Map,this.injectorDefTypes=new Set,this.onDestroy=new Set,this.destroyed=!1,deepForEach([def],function(injectorDef){return _this.processInjectorType(injectorDef,new Set)}),additionalProviders&&deepForEach(additionalProviders,function(provider){return _this.processProvider(provider)}),this.records.set(INJECTOR$1,makeRecord(void 0,this)),this.isRootInjector=this.records.has(APP_ROOT),this.injectorDefTypes.forEach(function(defType){return _this.get(defType)})}return R3Injector.prototype.destroy=function(){this.assertNotDestroyed(),this.destroyed=!0;try{this.onDestroy.forEach(function(service){return service.ngOnDestroy()})}finally{this.records.clear(),this.onDestroy.clear(),this.injectorDefTypes.clear()}},R3Injector.prototype.get=function(token,notFoundValue,flags){void 0===notFoundValue&&(notFoundValue=THROW_IF_NOT_FOUND),void 0===flags&&(flags=0),this.assertNotDestroyed();var value,previousInjector=setCurrentInjector(this);try{if(!(4&flags)){var record=this.records.get(token);if(void 0===record){var def=("function"==typeof(value=token)||"object"==typeof value&&value instanceof InjectionToken)&&getInjectableDef(token);def&&this.injectableDefInScope(def)&&(record=makeRecord(injectableDefFactory(token),NOT_YET),this.records.set(token,record))}if(void 0!==record)return this.hydrate(token,record)}return(2&flags?getNullInjector():this.parent).get(token,notFoundValue)}finally{setCurrentInjector(previousInjector)}},R3Injector.prototype.assertNotDestroyed=function(){if(this.destroyed)throw new Error("Injector has already been destroyed.")},R3Injector.prototype.processInjectorType=function(defOrWrappedDef,parents){var _this=this,def=getInjectorDef(defOrWrappedDef=resolveForwardRef(defOrWrappedDef)),ngModule=null==def&&defOrWrappedDef.ngModule||void 0,defType=void 0===ngModule?defOrWrappedDef:ngModule,providers=void 0!==ngModule&&defOrWrappedDef.providers||EMPTY_ARRAY$1;if(void 0!==ngModule&&(def=getInjectorDef(ngModule)),null!=def){if(parents.has(defType))throw new Error("Circular dependency: type "+stringify(defType)+" ends up importing itself.");if(this.injectorDefTypes.add(defType),this.records.set(defType,makeRecord(def.factory)),null!=def.imports){parents.add(defType);try{deepForEach(def.imports,function(imported){return _this.processInjectorType(imported,parents)})}finally{parents.delete(defType)}}null!=def.providers&&deepForEach(def.providers,function(provider){return _this.processProvider(provider)}),deepForEach(providers,function(provider){return _this.processProvider(provider)})}},R3Injector.prototype.processProvider=function(provider){var token=isTypeProvider(provider=resolveForwardRef(provider))?provider:resolveForwardRef(provider.provide),record=function(provider){var factory=providerToFactory(provider);return isValueProvider(provider)?makeRecord(void 0,provider.useValue):makeRecord(factory,NOT_YET)}(provider);if(isTypeProvider(provider)||!0!==provider.multi){var existing=this.records.get(token);if(existing&&void 0!==existing.multi)throw new Error("Mixed multi-provider for "+stringify(token))}else{var multiRecord_1=this.records.get(token);if(multiRecord_1){if(void 0===multiRecord_1.multi)throw new Error("Mixed multi-provider for "+token+".")}else(multiRecord_1=makeRecord(void 0,NOT_YET,!0)).factory=function(){return injectArgs(multiRecord_1.multi)},this.records.set(token,multiRecord_1);token=provider,multiRecord_1.multi.push(provider)}this.records.set(token,record)},R3Injector.prototype.hydrate=function(token,record){if(record.value===CIRCULAR$1)throw new Error("Circular dep for "+stringify(token));var value;return record.value===NOT_YET&&(record.value=CIRCULAR$1,record.value=record.factory()),"object"==typeof record.value&&record.value&&("object"==typeof(value=record.value)&&null!=value&&value.ngOnDestroy&&"function"==typeof value.ngOnDestroy)&&this.onDestroy.add(record.value),record.value},R3Injector.prototype.injectableDefInScope=function(def){return!!def.providedIn&&("string"==typeof def.providedIn?"any"===def.providedIn||"root"===def.providedIn&&this.isRootInjector:this.injectorDefTypes.has(def.providedIn))},R3Injector}();function injectableDefFactory(token){var injectableDef=getInjectableDef(token);if(null===injectableDef){if(token instanceof InjectionToken)throw new Error("Token "+stringify(token)+" is missing an ngInjectableDef definition.");return function(){return new token}}return injectableDef.factory}function providerToFactory(provider){var factory=void 0;if(isTypeProvider(provider))return injectableDefFactory(resolveForwardRef(provider));if(isValueProvider(provider))factory=function(){return resolveForwardRef(provider.useValue)};else if(provider.useExisting)factory=function(){return inject(resolveForwardRef(provider.useExisting))};else if(function(value){return!!value.useFactory}(provider))factory=function(){return provider.useFactory.apply(provider,injectArgs(provider.deps||[]))};else{var classRef_1=resolveForwardRef(provider.useClass||provider.provide);if(!function(value){return!!value.deps}(provider))return injectableDefFactory(classRef_1);factory=function(){return new(classRef_1.bind.apply(classRef_1,[void 0].concat(injectArgs(provider.deps))))}}return factory}function makeRecord(factory,value,multi){return void 0===value&&(value=NOT_YET),void 0===multi&&(multi=!1),{factory:factory,value:value,multi:multi?[]:void 0}}function deepForEach(input,fn){input.forEach(function(value){return Array.isArray(value)?deepForEach(value,fn):fn(value)})}function isValueProvider(value){return USE_VALUE in value}function isTypeProvider(value){return"function"==typeof value}function resolveProvider$1(provider,tInjectables,lInjectablesBlueprint,isComponent$$1,isViewProvider){if(provider=resolveForwardRef(provider),Array.isArray(provider))for(var i=0;i<provider.length;i++)resolveProvider$1(provider[i],tInjectables,lInjectablesBlueprint,isComponent$$1,isViewProvider);else{var viewData=getViewData(),token=isTypeProvider(provider)?provider:resolveForwardRef(provider.provide),providerFactory=providerToFactory(provider),previousOrParentTNode=getPreviousOrParentTNode(),beginIndex=65535&previousOrParentTNode.providerIndexes,endIndex=previousOrParentTNode.flags>>16,cptViewProvidersCount=previousOrParentTNode.providerIndexes>>16;if(isTypeProvider(provider)||!provider.multi){var factory=new NodeInjectorFactory(providerFactory,isViewProvider,directiveInject),existingFactoryIndex=indexOf(token,tInjectables,isViewProvider?beginIndex:beginIndex+cptViewProvidersCount,endIndex);-1==existingFactoryIndex?(diPublicInInjector(getOrCreateNodeInjectorForNode(previousOrParentTNode,viewData),viewData,token),tInjectables.push(token),previousOrParentTNode.flags+=65536,isViewProvider&&(previousOrParentTNode.providerIndexes+=65536),lInjectablesBlueprint.push(factory),viewData.push(factory)):(lInjectablesBlueprint[existingFactoryIndex]=factory,viewData[existingFactoryIndex]=factory)}else{var existingProvidersFactoryIndex=indexOf(token,tInjectables,beginIndex+cptViewProvidersCount,endIndex),existingViewProvidersFactoryIndex=indexOf(token,tInjectables,beginIndex,beginIndex+cptViewProvidersCount),doesProvidersFactoryExist=existingProvidersFactoryIndex>=0&&lInjectablesBlueprint[existingProvidersFactoryIndex],doesViewProvidersFactoryExist=existingViewProvidersFactoryIndex>=0&&lInjectablesBlueprint[existingViewProvidersFactoryIndex];if(isViewProvider&&!doesViewProvidersFactoryExist||!isViewProvider&&!doesProvidersFactoryExist){diPublicInInjector(getOrCreateNodeInjectorForNode(previousOrParentTNode,viewData),viewData,token);factory=function(factoryFn,index,isViewProvider,isComponent$$1,f){var factory=new NodeInjectorFactory(factoryFn,isViewProvider,directiveInject);return factory.multi=[],factory.index=index,factory.componentProviders=0,multiFactoryAdd(factory,f,isComponent$$1&&!isViewProvider),factory}(isViewProvider?multiViewProvidersFactoryResolver:multiProvidersFactoryResolver,lInjectablesBlueprint.length,isViewProvider,isComponent$$1,providerFactory);!isViewProvider&&doesViewProvidersFactoryExist&&(lInjectablesBlueprint[existingViewProvidersFactoryIndex].providerFactory=factory),tInjectables.push(token),previousOrParentTNode.flags+=65536,isViewProvider&&(previousOrParentTNode.providerIndexes+=65536),lInjectablesBlueprint.push(factory),viewData.push(factory)}else multiFactoryAdd(lInjectablesBlueprint[isViewProvider?existingViewProvidersFactoryIndex:existingProvidersFactoryIndex],providerFactory,!isViewProvider&&isComponent$$1);!isViewProvider&&isComponent$$1&&doesViewProvidersFactoryExist&&lInjectablesBlueprint[existingViewProvidersFactoryIndex].componentProviders++}}}function multiFactoryAdd(multiFactory,factory,isComponentProvider){multiFactory.multi.push(factory),isComponentProvider&&multiFactory.componentProviders++}function indexOf(item,arr,begin,end){for(var i=begin;i<end;i++)if(arr[i]===item)return i;return-1}function multiProvidersFactoryResolver(_,tData,lData,tNode){return multiResolve(this.multi,[])}function multiViewProvidersFactoryResolver(_,tData,lData,tNode){var result,factories=this.multi;if(this.providerFactory){var componentCount=this.providerFactory.componentProviders,multiProviders=getNodeInjectable(tData,lData,this.providerFactory.index,tNode);multiResolve(factories,result=multiProviders.slice(0,componentCount));for(var i=componentCount;i<multiProviders.length;i++)result.push(multiProviders[i])}else multiResolve(factories,result=[]);return result}function multiResolve(factories,result){for(var i=0;i<factories.length;i++){var factory=factories[i];result.push(factory())}return result}function ProvidersFeature(providers,viewProviders){return void 0===viewProviders&&(viewProviders=[]),function(definition){definition.providersResolver=function(def){
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var ComponentRef$1=function(){return function(){}}(),ComponentFactory$1=function(){return function(){}}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function noComponentFactoryError(component){var error=Error("No component factory found for "+stringify(component)+". Did you add it to @NgModule.entryComponents?");return error[ERROR_COMPONENT]=component,error}var ERROR_COMPONENT="ngComponent",_NullComponentFactoryResolver=function(){function _NullComponentFactoryResolver(){}return _NullComponentFactoryResolver.prototype.resolveComponentFactory=function(component){throw noComponentFactoryError(component)},_NullComponentFactoryResolver}(),ComponentFactoryResolver$1=function(){function ComponentFactoryResolver(){}return ComponentFactoryResolver.NULL=new _NullComponentFactoryResolver,ComponentFactoryResolver}(),CodegenComponentFactoryResolver=function(){function CodegenComponentFactoryResolver(factories,_parent,_ngModule){this._parent=_parent,this._ngModule=_ngModule,this._factories=new Map;for(var i=0;i<factories.length;i++){var factory=factories[i];this._factories.set(factory.componentType,factory)}}return CodegenComponentFactoryResolver.prototype.resolveComponentFactory=function(component){var factory=this._factories.get(component);if(!factory&&this._parent&&(factory=this._parent.resolveComponentFactory(component)),!factory)throw noComponentFactoryError(component);return new ComponentFactoryBoundToModule(factory,this._ngModule)},CodegenComponentFactoryResolver}(),ComponentFactoryBoundToModule=function(_super){function ComponentFactoryBoundToModule(factory,ngModule){var _this=_super.call(this)||this;return _this.factory=factory,_this.ngModule=ngModule,_this.selector=factory.selector,_this.componentType=factory.componentType,_this.ngContentSelectors=factory.ngContentSelectors,_this.inputs=factory.inputs,_this.outputs=factory.outputs,_this}return __extends(ComponentFactoryBoundToModule,_super),ComponentFactoryBoundToModule.prototype.create=function(injector,projectableNodes,rootSelectorOrNode,ngModule){return this.factory.create(injector,projectableNodes,rootSelectorOrNode,ngModule||this.ngModule)},ComponentFactoryBoundToModule}(ComponentFactory$1),ElementRef=function(){function ElementRef(nativeElement){this.nativeElement=nativeElement}return ElementRef.__NG_ELEMENT_ID__=function(){return SWITCH_ELEMENT_REF_FACTORY(ElementRef)},ElementRef}(),SWITCH_ELEMENT_REF_FACTORY__POST_R3__=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(ElementRefToken){return createElementRef(ElementRefToken,getPreviousOrParentTNode(),getViewData())},SWITCH_ELEMENT_REF_FACTORY=noop,RenderComponentType=function(){return function(id,templateUrl,slotCount,encapsulation,styles,animations){this.id=id,this.templateUrl=templateUrl,this.slotCount=slotCount,this.encapsulation=encapsulation,this.styles=styles,this.animations=animations}}(),RenderDebugInfo=function(){return function(){}}(),Renderer=function(){return function(){}}(),RootRenderer=(new InjectionToken("Renderer2Interceptor"),function(){return function(){}}()),RendererFactory2=function(){return function(){}}(),RendererStyleFlags2={Important:1,DashCase:2};RendererStyleFlags2[RendererStyleFlags2.Important]="Important",RendererStyleFlags2[RendererStyleFlags2.DashCase]="DashCase";var Renderer2=function(){function Renderer2(){}return Renderer2.__NG_ELEMENT_ID__=function(){return SWITCH_RENDERER2_FACTORY()},Renderer2}(),SWITCH_RENDERER2_FACTORY__POST_R3__=function(){return function(view){var renderer=view[RENDERER];if(isProceduralRenderer(renderer))return renderer;throw new Error("Cannot inject Renderer2 when the application uses Renderer3!")}(getViewData())},SWITCH_RENDERER2_FACTORY=noop,ComponentFactoryResolver$$1=function(_super){function ComponentFactoryResolver$$1(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(ComponentFactoryResolver$$1,_super),ComponentFactoryResolver$$1.prototype.resolveComponentFactory=function(component){ngDevMode&&assertComponentType(component);var componentDef=getComponentDef(component);return new ComponentFactory$$1(componentDef)},ComponentFactoryResolver$$1}(ComponentFactoryResolver$1);function toRefArray(map){var array=[];for(var nonMinified in map)if(map.hasOwnProperty(nonMinified)){var minified=map[nonMinified];array.push({propName:minified,templateName:nonMinified})}return array}var ROOT_CONTEXT=new InjectionToken("ROOT_CONTEXT_TOKEN",{providedIn:"root",factory:function(){return createRootContext(inject(SCHEDULER))}}),SCHEDULER=new InjectionToken("SCHEDULER_TOKEN",{providedIn:"root",factory:function(){return defaultScheduler}}),WRAP_RENDERER_FACTORY2=new InjectionToken("WRAP_RENDERER_FACTORY2"),ComponentFactory$$1=function(_super){function ComponentFactory$$1(componentDef){var _this=_super.call(this)||this;return _this.componentDef=componentDef,_this.componentType=componentDef.type,_this.selector=componentDef.selectors[0][0],_this.ngContentSelectors=[],_this}return __extends(ComponentFactory$$1,_super),Object.defineProperty(ComponentFactory$$1.prototype,"inputs",{get:function(){return toRefArray(this.componentDef.inputs)},enumerable:!0,configurable:!0}),Object.defineProperty(ComponentFactory$$1.prototype,"outputs",{get:function(){return toRefArray(this.componentDef.outputs)},enumerable:!0,configurable:!0}),ComponentFactory$$1.prototype.create=function(injector,projectableNodes,rootSelectorOrNode,ngModule){var rendererFactory,isInternalRootView=void 0===rootSelectorOrNode;ngModule?rendererFactory=ngModule.injector.get(WRAP_RENDERER_FACTORY2,function(v){return v})(ngModule.injector.get(RendererFactory2)):rendererFactory=domRendererFactory3;var hostRNode=isInternalRootView?elementCreate(this.selector,rendererFactory.createRenderer(null,this.componentDef)):locateHostElement(rendererFactory,rootSelectorOrNode),rootFlags=this.componentDef.onPush?68:66,rootContext=ngModule&&!isInternalRootView?ngModule.injector.get(ROOT_CONTEXT):createRootContext(),renderer=rendererFactory.createRenderer(hostRNode,this.componentDef),rootView=createLViewData(renderer,createTView(-1,null,1,0,null,null,null),rootContext,rootFlags);rootView[INJECTOR]=ngModule&&ngModule.injector||null;var component,tElementNode,oldView=enterView(rootView,null);try{rendererFactory.begin&&rendererFactory.begin();var componentView=createRootComponentView(hostRNode,this.componentDef,rootView,renderer);if(tElementNode=getTNode(0,rootView),projectableNodes)for(var index=0,tView=rootView[TVIEW],projection$$1=tElementNode.projection=[],i=0;i<projectableNodes.length;i++){for(var nodeList=projectableNodes[i],firstTNode=null,previousTNode=null,j=0;j<nodeList.length;j++){tView.firstTemplatePass&&(tView.expandoStartIndex++,tView.blueprint.splice(++index+HEADER_OFFSET,0,null),tView.data.splice(index+HEADER_OFFSET,0,null),rootView.splice(index+HEADER_OFFSET,0,null));var tNode=createNodeAtIndex(index,3,nodeList[j],null,null);previousTNode?previousTNode.next=tNode:firstTNode=tNode,previousTNode=tNode}projection$$1.push(firstTNode)}component=createRootComponent(componentView,this.componentDef,rootView,rootContext,[LifecycleHooksFeature]),refreshDescendantViews(rootView,1)}finally{leaveView(oldView,!0),rendererFactory.end&&rendererFactory.end()}var componentRef=new ComponentRef$$1(this.componentType,component,rootView,injector,createElementRef(ElementRef,tElementNode,rootView));return isInternalRootView&&(componentRef.hostView._tViewNode.child=tElementNode),componentRef},ComponentFactory$$1}(ComponentFactory$1),ComponentRef$$1=(new ComponentFactoryResolver$$1,function(_super){function ComponentRef$$1(componentType,instance,rootView,injector,location){var _this=_super.call(this)||this;return _this.location=location,_this.destroyCbs=[],_this.instance=instance,_this.hostView=_this.changeDetectorRef=new RootViewRef(rootView),_this.hostView._tViewNode=createViewNode(-1,rootView),_this.injector=injector,_this.componentType=componentType,_this}return __extends(ComponentRef$$1,_super),ComponentRef$$1.prototype.destroy=function(){ngDevMode&&assertDefined(this.destroyCbs,"NgModule already destroyed"),this.destroyCbs.forEach(function(fn){return fn()}),this.destroyCbs=null},ComponentRef$$1.prototype.onDestroy=function(callback){ngDevMode&&assertDefined(this.destroyCbs,"NgModule already destroyed"),this.destroyCbs.push(callback)},ComponentRef$$1}(ComponentRef$1)),i18nTagRegex=/{\$([^}]+)}/g;function appendI18nNode(tNode,parentTNode,previousTNode){ngDevMode&&ngDevMode.rendererMoveNode++;var viewData=getViewData();viewData[TVIEW].firstTemplatePass&&(previousTNode===parentTNode&&tNode!==parentTNode.child?(tNode.next=parentTNode.child,parentTNode.child=tNode):previousTNode!==parentTNode&&tNode!==previousTNode.next?(tNode.next=previousTNode.next,previousTNode.next=tNode):tNode.next=null,parentTNode!==viewData[HOST_NODE]&&(tNode.parent=parentTNode)),appendChild(getNativeByTNode(tNode,viewData),tNode,viewData);var slotValue=viewData[tNode.index];return 0!==tNode.type&&isLContainer(slotValue)&&appendChild(slotValue[NATIVE],tNode,viewData),tNode}function i18nAttribute(index,attrs){}function i18nExp(expression){}function i18nStart(index,message,subTemplateIndex){void 0===subTemplateIndex&&(subTemplateIndex=0)}function i18nEnd(){}function i18nApply(startIndex,instructions){var viewData=getViewData();if(ngDevMode&&assertEqual(viewData[BINDING_INDEX],viewData[TVIEW].bindingStartIndex,"i18nApply should be called before any binding"),instructions){var view,tView,renderer=getRenderer(),localParentTNode=getTNode(startIndex,viewData).parent||viewData[HOST_NODE],localPreviousTNode=localParentTNode;resetComponentState();for(var i=0;i<instructions.length;i++){var instruction=instructions[i];switch(-536870912&instruction){case 1073741824:var elementTNode=getTNode(536870911&instruction,viewData);localPreviousTNode=appendI18nNode(elementTNode,localParentTNode,localPreviousTNode),localParentTNode=elementTNode;break;case 1610612736:case-2147483648:case-1610612736:localPreviousTNode=appendI18nNode(getTNode(536870911&instruction,viewData),localParentTNode,localPreviousTNode);break;case 536870912:ngDevMode&&ngDevMode.rendererCreateTextNode++;var textRNode=createTextNode(instructions[++i],renderer);tView=void 0,(tView=(view=viewData)[TVIEW]).firstTemplatePass&&(tView.expandoStartIndex++,tView.blueprint.push(null),view.push(null)),localPreviousTNode=appendI18nNode(createNodeAtIndex(viewData.length-1-HEADER_OFFSET,3,textRNode,null,null),localParentTNode,localPreviousTNode),resetComponentState();break;case-1073741824:localPreviousTNode=localParentTNode,localParentTNode=localParentTNode.parent||viewData[HOST_NODE];break;case-536870912:ngDevMode&&ngDevMode.rendererRemoveNode++;var removeIndex=536870911&instruction,removedElement=getNativeByIndex(removeIndex,viewData),removedTNode=getTNode(removeIndex,viewData);removeChild(removedTNode,removedElement||null,viewData);var slotValue=load(removeIndex);if(isLContainer(slotValue)){var lContainer=slotValue;0!==removedTNode.type&&removeChild(removedTNode,lContainer[NATIVE]||null,viewData),removedTNode.detached=!0,lContainer[RENDER_PARENT]=null}}}}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function pureFunction0(slotOffset,pureFn,thisArg){var bindingIndex=getBindingRoot()+slotOffset;return getCreationMode()?updateBinding(bindingIndex,thisArg?pureFn.call(thisArg):pureFn()):getBinding(bindingIndex)}function pureFunction1(slotOffset,pureFn,exp,thisArg){var bindingIndex=getBindingRoot()+slotOffset;return bindingUpdated(bindingIndex,exp)?updateBinding(bindingIndex+1,thisArg?pureFn.call(thisArg,exp):pureFn(exp)):getBinding(bindingIndex+1)}function pureFunction2(slotOffset,pureFn,exp1,exp2,thisArg){var bindingIndex=getBindingRoot()+slotOffset;return bindingUpdated2(bindingIndex,exp1,exp2)?updateBinding(bindingIndex+2,thisArg?pureFn.call(thisArg,exp1,exp2):pureFn(exp1,exp2)):getBinding(bindingIndex+2)}function pureFunction3(slotOffset,pureFn,exp1,exp2,exp3,thisArg){var bindingIndex=getBindingRoot()+slotOffset;return bindingUpdated3(bindingIndex,exp1,exp2,exp3)?updateBinding(bindingIndex+3,thisArg?pureFn.call(thisArg,exp1,exp2,exp3):pureFn(exp1,exp2,exp3)):getBinding(bindingIndex+3)}function pureFunction4(slotOffset,pureFn,exp1,exp2,exp3,exp4,thisArg){var bindingIndex=getBindingRoot()+slotOffset;return bindingUpdated4(bindingIndex,exp1,exp2,exp3,exp4)?updateBinding(bindingIndex+4,thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4):pureFn(exp1,exp2,exp3,exp4)):getBinding(bindingIndex+4)}function pureFunction5(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,thisArg){var bindingIndex=getBindingRoot()+slotOffset,different=bindingUpdated4(bindingIndex,exp1,exp2,exp3,exp4);return bindingUpdated(bindingIndex+4,exp5)||different?updateBinding(bindingIndex+5,thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5):pureFn(exp1,exp2,exp3,exp4,exp5)):getBinding(bindingIndex+5)}function pureFunction6(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,exp6,thisArg){var bindingIndex=getBindingRoot()+slotOffset,different=bindingUpdated4(bindingIndex,exp1,exp2,exp3,exp4);return bindingUpdated2(bindingIndex+4,exp5,exp6)||different?updateBinding(bindingIndex+6,thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6):pureFn(exp1,exp2,exp3,exp4,exp5,exp6)):getBinding(bindingIndex+6)}function pureFunction7(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,exp6,exp7,thisArg){var bindingIndex=getBindingRoot()+slotOffset,different=bindingUpdated4(bindingIndex,exp1,exp2,exp3,exp4);return bindingUpdated3(bindingIndex+4,exp5,exp6,exp7)||different?updateBinding(bindingIndex+7,thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6,exp7):pureFn(exp1,exp2,exp3,exp4,exp5,exp6,exp7)):getBinding(bindingIndex+7)}function pureFunction8(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8,thisArg){var bindingIndex=getBindingRoot()+slotOffset,different=bindingUpdated4(bindingIndex,exp1,exp2,exp3,exp4);return bindingUpdated4(bindingIndex+4,exp5,exp6,exp7,exp8)||different?updateBinding(bindingIndex+8,thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8):pureFn(exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8)):getBinding(bindingIndex+8)}function pureFunctionV(slotOffset,pureFn,exps,thisArg){for(var bindingIndex=getBindingRoot()+slotOffset,different=!1,i=0;i<exps.length;i++)bindingUpdated(bindingIndex++,exps[i])&&(different=!0);return different?updateBinding(bindingIndex,pureFn.apply(thisArg,exps)):getBinding(bindingIndex)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function pipe(index,pipeName){var pipeDef,tView=getTView(),adjustedIndex=index+HEADER_OFFSET;tView.firstTemplatePass?(pipeDef=function(name,registry){if(registry)for(var i=0;i<registry.length;i++){var pipeDef=registry[i];if(name===pipeDef.name)return pipeDef}throw new Error("Pipe with name '"+name+"' not found!")}(pipeName,tView.pipeRegistry),tView.data[adjustedIndex]=pipeDef,pipeDef.onDestroy&&(tView.pipeDestroyHooks||(tView.pipeDestroyHooks=[])).push(adjustedIndex,pipeDef.onDestroy)):pipeDef=tView.data[adjustedIndex];var pipeInstance=pipeDef.factory(null);return store(index,pipeInstance),pipeInstance}function pipeBind1(index,slotOffset,v1){var pipeInstance=load(index);return isPure(index)?pureFunction1(slotOffset,pipeInstance.transform,v1,pipeInstance):pipeInstance.transform(v1)}function pipeBind2(index,slotOffset,v1,v2){var pipeInstance=load(index);return isPure(index)?pureFunction2(slotOffset,pipeInstance.transform,v1,v2,pipeInstance):pipeInstance.transform(v1,v2)}function pipeBind3(index,slotOffset,v1,v2,v3){var pipeInstance=load(index);return isPure(index)?pureFunction3(slotOffset,pipeInstance.transform,v1,v2,v3,pipeInstance):pipeInstance.transform(v1,v2,v3)}function pipeBind4(index,slotOffset,v1,v2,v3,v4){var pipeInstance=load(index);return isPure(index)?pureFunction4(slotOffset,pipeInstance.transform,v1,v2,v3,v4,pipeInstance):pipeInstance.transform(v1,v2,v3,v4)}function pipeBindV(index,slotOffset,values){var pipeInstance=load(index);return isPure(index)?pureFunctionV(slotOffset,pipeInstance.transform,values,pipeInstance):pipeInstance.transform.apply(pipeInstance,values)}function isPure(index){return getTView().data[index+HEADER_OFFSET].pure}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var _devMode=!0,_runModeLocked=!1;function isDevMode(){return _runModeLocked=!0,_devMode}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */(el)?el.content:null}var SecurityContext={NONE:0,HTML:1,STYLE:2,SCRIPT:3,URL:4,RESOURCE_URL:5};SecurityContext[SecurityContext.NONE]="NONE",SecurityContext[SecurityContext.HTML]="HTML",SecurityContext[SecurityContext.STYLE]="STYLE",SecurityContext[SecurityContext.SCRIPT]="SCRIPT",SecurityContext[SecurityContext.URL]="URL",SecurityContext[SecurityContext.RESOURCE_URL]="RESOURCE_URL";var Sanitizer=function(){return function(){}}(),SAFE_STYLE_VALUE=new RegExp("^([-,.\"'%_!# a-zA-Z0-9]+|(?:(?:matrix|translate|scale|rotate|skew|perspective)(?:X|Y|3d)?|(?:rgb|hsl)a?|(?:repeating-)?(?:linear|radial)-gradient|(?:calc|attr))\\([-0-9.%, #a-zA-Z]+\\))$","g"),URL_RE=/^url\(([^)]+)\)$/;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function sanitizeHtml(unsafeHtml){var s=getCurrentSanitizer();return s?s.sanitize(SecurityContext.HTML,unsafeHtml)||"":allowSanitizationBypass(unsafeHtml,"Html")?unsafeHtml.toString():_sanitizeHtml(document,stringify$1(unsafeHtml))}function sanitizeStyle(unsafeStyle){var s=getCurrentSanitizer();return s?s.sanitize(SecurityContext.STYLE,unsafeStyle)||"":allowSanitizationBypass(unsafeStyle,"Style")?unsafeStyle.toString():_sanitizeStyle(stringify$1(unsafeStyle))}function sanitizeUrl(unsafeUrl){var s=getCurrentSanitizer();return s?s.sanitize(SecurityContext.URL,unsafeUrl)||"":allowSanitizationBypass(unsafeUrl,"Url")?unsafeUrl.toString():_sanitizeUrl(stringify$1(unsafeUrl))}function sanitizeResourceUrl(unsafeResourceUrl){var s=getCurrentSanitizer();if(s)return s.sanitize(SecurityContext.RESOURCE_URL,unsafeResourceUrl)||"";if(allowSanitizationBypass(unsafeResourceUrl,"ResourceUrl"))return unsafeResourceUrl.toString();throw new Error("unsafe value used in a resource URL context (see http://g.co/ng/security#xss)")}var angularCoreEnv={"ɵdefineBase":defineBase,"ɵdefineComponent":defineComponent,"ɵdefineDirective":defineDirective,defineInjectable:defineInjectable,defineInjector:defineInjector,"ɵdefineNgModule":defineNgModule,"ɵdefinePipe":definePipe,"ɵdirectiveInject":directiveInject,"ɵgetFactoryOf":getFactoryOf,"ɵgetInheritedFactory":getInheritedFactory,inject:inject,"ɵinjectAttribute":injectAttribute,"ɵtemplateRefExtractor":templateRefExtractor,"ɵNgOnChangesFeature":NgOnChangesFeature,"ɵProvidersFeature":ProvidersFeature,"ɵInheritDefinitionFeature":InheritDefinitionFeature,"ɵelementAttribute":elementAttribute,"ɵbind":bind,"ɵcontainer":container,"ɵnextContext":nextContext,"ɵcontainerRefreshStart":containerRefreshStart,"ɵcontainerRefreshEnd":containerRefreshEnd,"ɵloadQueryList":loadQueryList,"ɵnamespaceHTML":namespaceHTML,"ɵnamespaceMathML":namespaceMathML,"ɵnamespaceSVG":namespaceSVG,"ɵenableBindings":enableBindings,"ɵdisableBindings":disableBindings,"ɵelementStart":elementStart,"ɵelementEnd":elementEnd,"ɵelement":element,"ɵEC":function(index,attrs,localRefs){var viewData=getViewData(),tView=getTView(),renderer=getRenderer();ngDevMode&&assertEqual(viewData[BINDING_INDEX],tView.bindingStartIndex,"element containers should be created before any bindings"),ngDevMode&&ngDevMode.rendererCreateComment++;var native=renderer.createComment(ngDevMode?"ng-container":"");ngDevMode&&assertDataInRange(index-1),appendChild(native,createNodeAtIndex(index,4,native,null,attrs||null),viewData),createDirectivesAndLocals(tView,viewData,localRefs)},"ɵeC":function(){var previousOrParentTNode=getPreviousOrParentTNode(),tView=getTView();getIsParent()?setIsParent(!1):(ngDevMode&&assertHasParent(),setPreviousOrParentTNode(previousOrParentTNode=previousOrParentTNode.parent)),ngDevMode&&assertNodeType(previousOrParentTNode,4);var currentQueries=getCurrentQueries();currentQueries&&setCurrentQueries(currentQueries.addNode(previousOrParentTNode)),queueLifecycleHooks(previousOrParentTNode.flags,tView)},"ɵpureFunction0":pureFunction0,"ɵpureFunction1":pureFunction1,"ɵpureFunction2":pureFunction2,"ɵpureFunction3":pureFunction3,"ɵpureFunction4":pureFunction4,"ɵpureFunction5":pureFunction5,"ɵpureFunction6":pureFunction6,"ɵpureFunction7":pureFunction7,"ɵpureFunction8":pureFunction8,"ɵpureFunctionV":pureFunctionV,"ɵgetCurrentView":getCurrentView,"ɵrestoreView":restoreView,"ɵinterpolation1":interpolation1,"ɵinterpolation2":interpolation2,"ɵinterpolation3":interpolation3,"ɵinterpolation4":interpolation4,"ɵinterpolation5":interpolation5,"ɵinterpolation6":interpolation6,"ɵinterpolation7":interpolation7,"ɵinterpolation8":interpolation8,"ɵinterpolationV":interpolationV,"ɵelementClassProp":elementClassProp,"ɵlistener":listener,"ɵload":load,"ɵprojection":projection,"ɵelementProperty":elementProperty,"ɵpipeBind1":pipeBind1,"ɵpipeBind2":pipeBind2,"ɵpipeBind3":pipeBind3,"ɵpipeBind4":pipeBind4,"ɵpipeBindV":pipeBindV,"ɵprojectionDef":projectionDef,"ɵpipe":pipe,"ɵquery":query,"ɵqueryRefresh":queryRefresh,"ɵregisterContentQuery":registerContentQuery,"ɵreference":reference,"ɵelementStyling":elementStyling,"ɵelementStylingMap":elementStylingMap,"ɵelementStyleProp":elementStyleProp,"ɵelementStylingApply":elementStylingApply,"ɵtemplate":template,"ɵtext":text,"ɵtextBinding":textBinding,"ɵembeddedViewStart":embeddedViewStart,"ɵembeddedViewEnd":embeddedViewEnd,"ɵi18nAttribute":i18nAttribute,"ɵi18nExp":i18nExp,"ɵi18nStart":i18nStart,"ɵi18nEnd":i18nEnd,"ɵi18nApply":i18nApply,"ɵsanitizeHtml":sanitizeHtml,"ɵsanitizeStyle":sanitizeStyle,"ɵdefaultStyleSanitizer":function(prop,value){return void 0===value?"background-image"===prop||"background"===prop||"border-image"===prop||"filter"===prop||"filter"===prop||"list-style"===prop||"list-style-image"===prop:sanitizeStyle(value)},"ɵsanitizeResourceUrl":sanitizeResourceUrl,"ɵsanitizeScript":function(unsafeScript){var s=getCurrentSanitizer();if(s)return s.sanitize(SecurityContext.SCRIPT,unsafeScript)||"";if(allowSanitizationBypass(unsafeScript,"Script"))return unsafeScript.toString();throw new Error("unsafe value used in a script context")},"ɵsanitizeUrl":sanitizeUrl},Type=Function;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function isType(v){return"function"==typeof v}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */(compiler,dep)})}var EMPTY_ARRAY$2=[];function compileNgModule(moduleType,ngModule){compileNgModuleDefs(moduleType,ngModule),function(moduleType,ngModule){var declarations=flatten$1(ngModule.declarations||EMPTY_ARRAY$2),transitiveScopes=transitiveScopesFor(moduleType);declarations.forEach(function(declaration){if(declaration.hasOwnProperty(NG_COMPONENT_DEF)){var component=declaration,componentDef=getComponentDef(component);patchComponentDefWithScope(componentDef,transitiveScopes)}else declaration.hasOwnProperty(NG_DIRECTIVE_DEF)||declaration.hasOwnProperty(NG_PIPE_DEF)||(declaration.ngSelectorScope=moduleType)})}(moduleType,ngModule)}function compileNgModuleDefs(moduleType,ngModule){var declarations=flatten$1(ngModule.declarations||EMPTY_ARRAY$2),ngModuleDef=null;Object.defineProperty(moduleType,NG_MODULE_DEF,{configurable:!0,get:function(){return null===ngModuleDef&&(ngModuleDef=getCompilerFacade().compileNgModule(angularCoreEnv,"ng://"+moduleType.name+"/ngModuleDef.js",{type:moduleType,bootstrap:flatten$1(ngModule.bootstrap||EMPTY_ARRAY$2),declarations:declarations,imports:flatten$1(ngModule.imports||EMPTY_ARRAY$2).map(expandModuleWithProviders),exports:flatten$1(ngModule.exports||EMPTY_ARRAY$2).map(expandModuleWithProviders),emitInline:!0})),ngModuleDef}});var ngInjectorDef=null;Object.defineProperty(moduleType,NG_INJECTOR_DEF,{get:function(){if(null===ngInjectorDef){var meta={name:moduleType.name,type:moduleType,deps:reflectDependencies(moduleType),providers:ngModule.providers||EMPTY_ARRAY$2,imports:[ngModule.imports||EMPTY_ARRAY$2,ngModule.exports||EMPTY_ARRAY$2]};ngInjectorDef=getCompilerFacade().compileInjector(angularCoreEnv,"ng://"+moduleType.name+"/ngInjectorDef.js",meta)}return ngInjectorDef},configurable:!!ngDevMode})}function patchComponentDefWithScope(componentDef,transitiveScopes){componentDef.directiveDefs=function(){return Array.from(transitiveScopes.compilation.directives).map(function(dir){return getDirectiveDef(dir)||getComponentDef(dir)}).filter(function(def){return!!def})},componentDef.pipeDefs=function(){return Array.from(transitiveScopes.compilation.pipes).map(function(pipe){return getPipeDef(pipe)})}}function transitiveScopesFor(moduleType){if(!isNgModule(moduleType))throw new Error(moduleType.name+" does not have an ngModuleDef");var def=getNgModuleDef(moduleType);if(null!==def.transitiveCompileScopes)return def.transitiveCompileScopes;var scopes={compilation:{directives:new Set,pipes:new Set},exported:{directives:new Set,pipes:new Set}};return def.declarations.forEach(function(declared){getPipeDef(declared)?scopes.compilation.pipes.add(declared):scopes.compilation.directives.add(declared)}),def.imports.forEach(function(imported){var importedTyped=imported;if(!isNgModule(importedTyped))throw new Error("Importing "+importedTyped.name+" which does not have an ngModuleDef");var importedScope=transitiveScopesFor(importedTyped);importedScope.exported.directives.forEach(function(entry){return scopes.compilation.directives.add(entry)}),importedScope.exported.pipes.forEach(function(entry){return scopes.compilation.pipes.add(entry)})}),def.exports.forEach(function(exported){var exportedTyped=exported;if(isNgModule(exportedTyped)){var exportedScope=transitiveScopesFor(exportedTyped);exportedScope.exported.directives.forEach(function(entry){scopes.compilation.directives.add(entry),scopes.exported.directives.add(entry)}),exportedScope.exported.pipes.forEach(function(entry){scopes.compilation.pipes.add(entry),scopes.exported.pipes.add(entry)})}else getNgModuleDef(exportedTyped)?scopes.exported.pipes.add(exportedTyped):scopes.exported.directives.add(exportedTyped)}),def.transitiveCompileScopes=scopes,scopes}function flatten$1(values){var out=[];return values.forEach(function(value){Array.isArray(value)?out.push.apply(out,flatten$1(value)):out.push(value)}),out}function expandModuleWithProviders(value){return function(value){return void 0!==value.ngModule}(value)?value.ngModule:value}function isNgModule(value){return!!getNgModuleDef(value)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function compileComponent(type,metadata){var ngComponentDef=null;!function(metadata){componentNeedsResolution(metadata)&&componentResourceResolutionQueue.add(metadata)}(metadata),Object.defineProperty(type,NG_COMPONENT_DEF,{get:function(){var compiler=getCompilerFacade();if(null===ngComponentDef){if(componentNeedsResolution(metadata)){var error=["Component '"+stringify(type)+"' is not resolved:"];throw metadata.templateUrl&&error.push(" - templateUrl: "+stringify(metadata.templateUrl)),metadata.styleUrls&&metadata.styleUrls.length&&error.push(" - styleUrls: "+JSON.stringify(metadata.styleUrls)),error.push("Did you run and wait for 'resolveComponentResources()'?"),new Error(error.join("\n"))}var meta=__assign({},directiveMetadata(type,metadata),{template:metadata.template||"",preserveWhitespaces:metadata.preserveWhitespaces||!1,styles:metadata.styles||EMPTY_ARRAY,animations:metadata.animations,viewQueries:extractQueriesMetadata(getReflect().propMetadata(type),isViewQuery),directives:new Map,pipes:new Map,encapsulation:metadata.encapsulation||ViewEncapsulation.Emulated,viewProviders:metadata.viewProviders||null});if(ngComponentDef=compiler.compileComponent(angularCoreEnv,"ng://"+stringify(type)+"/template.html",meta),void 0!==type.ngSelectorScope){var scopes=transitiveScopesFor(type.ngSelectorScope);patchComponentDefWithScope(ngComponentDef,scopes)}}return ngComponentDef},configurable:!!ngDevMode})}function compileDirective(type,directive){var ngDirectiveDef=null;Object.defineProperty(type,NG_DIRECTIVE_DEF,{get:function(){if(null===ngDirectiveDef){var facade=directiveMetadata(type,directive);ngDirectiveDef=getCompilerFacade().compileDirective(angularCoreEnv,"ng://"+(type&&type.name)+"/ngDirectiveDef.js",facade)}return ngDirectiveDef},configurable:!!ngDevMode})}function directiveMetadata(type,metadata){var propMetadata=getReflect().propMetadata(type);return{name:type.name,type:type,typeArgumentCount:0,selector:metadata.selector,deps:reflectDependencies(type),host:metadata.host||EMPTY_OBJ,propMetadata:propMetadata,inputs:metadata.inputs||EMPTY_ARRAY,outputs:metadata.outputs||EMPTY_ARRAY,queries:extractQueriesMetadata(propMetadata,isContentQuery),lifecycle:{usesOnChanges:void 0!==type.prototype.ngOnChanges},typeSourceSpan:null,usesInheritance:!function(type){return Object.getPrototypeOf(type.prototype)===Object.prototype}(type),exportAs:metadata.exportAs||null,providers:metadata.providers||null}}var EMPTY_OBJ={};function extractQueriesMetadata(propMetadata,isQueryAnn){var queriesMeta=[],_loop_1=function(field){propMetadata.hasOwnProperty(field)&&propMetadata[field].forEach(function(ann){isQueryAnn(ann)&&queriesMeta.push(function(propertyName,ann){return{propertyName:propertyName,predicate:(selector=ann.selector,"string"==typeof selector?selector.split(",").map(function(piece){return piece.trim()}):selector),descendants:ann.descendants,first:ann.first,read:ann.read?ann.read:null};var selector}(field,ann))})};for(var field in propMetadata)_loop_1(field);return queriesMeta}function isContentQuery(value){var name=value.ngMetadataName;return"ContentChild"===name||"ContentChildren"===name}function isViewQuery(value){var name=value.ngMetadataName;return"ViewChild"===name||"ViewChildren"===name}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var NgModule=makeDecorator("NgModule",function(ngModule){return ngModule},void 0,void 0,function(type,meta){return SWITCH_COMPILE_NGMODULE(type,meta)});var SWITCH_COMPILE_NGMODULE__POST_R3__=compileNgModule,SWITCH_COMPILE_NGMODULE=function(moduleType,metadata){var imports=metadata&&metadata.imports||[];metadata&&metadata.exports&&(imports=imports.concat([metadata.exports])),moduleType.ngInjectorDef=defineInjector({factory:convertInjectableProviderToFactory(moduleType,{useClass:moduleType}),providers:metadata&&metadata.providers,imports:imports})},Version=function(){return function(full){this.full=full,this.major=full.split(".")[0],this.minor=full.split(".")[1],this.patch=full.split(".").slice(2).join(".")}}(),VERSION=new Version("7.1.0-beta.2-da59206995");var USE_VALUE$2=getClosureSafeProperty({provide:String,useValue:getClosureSafeProperty});function isUseClassProvider(meta){return void 0!==meta.useClass}function isUseValueProvider(meta){return USE_VALUE$2 in meta}function isUseFactoryProvider(meta){return void 0!==meta.useFactory}function isUseExistingProvider(meta){return void 0!==meta.useExisting}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var Injectable=makeDecorator("Injectable",void 0,void 0,void 0,function(type,meta){return SWITCH_COMPILE_INJECTABLE(type,meta)});var SWITCH_COMPILE_INJECTABLE__POST_R3__=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(type,srcMeta){var def=null;Object.defineProperty(type,NG_INJECTABLE_DEF,{get:function(){if(null===def){var meta_1=srcMeta||{providedIn:null},hasAProvider=isUseClassProvider(meta_1)||isUseFactoryProvider(meta_1)||isUseValueProvider(meta_1)||isUseExistingProvider(meta_1),compilerMeta={name:type.name,type:type,providedIn:meta_1.providedIn,ctorDeps:reflectDependencies(type),userDeps:void 0};if((isUseClassProvider(meta_1)||isUseFactoryProvider(meta_1))&&void 0!==meta_1.deps&&(compilerMeta.userDeps=convertDependencies(meta_1.deps)),hasAProvider)if(isUseClassProvider(meta_1))compilerMeta.useClass=meta_1.useClass;else if(isUseValueProvider(meta_1))compilerMeta.useValue=meta_1.useValue;else if(isUseFactoryProvider(meta_1))compilerMeta.useFactory=meta_1.useFactory;else{if(!isUseExistingProvider(meta_1))throw new Error("Unreachable state.");compilerMeta.useExisting=meta_1.useExisting}else compilerMeta.useClass=type;def=getCompilerFacade().compileInjectable(angularCoreEnv,"ng://"+type.name+"/ngInjectableDef.js",compilerMeta)}return def}})},SWITCH_COMPILE_INJECTABLE=function(injectableType,options){options&&void 0!==options.providedIn&&!getInjectableDef(injectableType)&&(injectableType.ngInjectableDef=defineInjectable({providedIn:options.providedIn,factory:convertInjectableProviderToFactory(injectableType,options)}))},ERROR_DEBUG_CONTEXT="ngDebugContext",ERROR_ORIGINAL_ERROR="ngOriginalError",ERROR_LOGGER="ngErrorLogger";function getDebugContext(error){return error[ERROR_DEBUG_CONTEXT]}function getOriginalError(error){return error[ERROR_ORIGINAL_ERROR]}function defaultErrorLogger(console){for(var values=[],_i=1;_i<arguments.length;_i++)values[_i-1]=arguments[_i];console.error.apply(console,values)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var _platform,_testabilityGetter=new(function(){function _NoopGetTestability(){}return _NoopGetTestability.prototype.addToWindow=function(registry){},_NoopGetTestability.prototype.findTestabilityInTree=function(registry,elem,findInAncestors){return null},_NoopGetTestability}()),compileNgModuleFactory=function(injector,options,moduleType){return injector.get(CompilerFactory).createCompiler([options]).compileModuleAsync(moduleType)};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var NgModuleFactoryLoader=function(){return function(){}}(),moduleFactories=new Map;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var ViewContainerRef=function(){function ViewContainerRef(){}return ViewContainerRef.__NG_ELEMENT_ID__=function(){return SWITCH_VIEW_CONTAINER_REF_FACTORY(ViewContainerRef,ElementRef)},ViewContainerRef}(),SWITCH_VIEW_CONTAINER_REF_FACTORY__POST_R3__=function(ViewContainerRefToken,ElementRefToken){return function(ViewContainerRefToken,ElementRefToken,hostTNode,hostView){var lContainer;R3ViewContainerRef||(R3ViewContainerRef=function(_super){function ViewContainerRef_(_lContainer,_hostTNode,_hostView){var _this=_super.call(this)||this;return _this._lContainer=_lContainer,_this._hostTNode=_hostTNode,_this._hostView=_hostView,_this._viewRefs=[],_this}return __extends(ViewContainerRef_,_super),Object.defineProperty(ViewContainerRef_.prototype,"element",{get:function(){return createElementRef(ElementRefToken,this._hostTNode,this._hostView)},enumerable:!0,configurable:!0}),Object.defineProperty(ViewContainerRef_.prototype,"injector",{get:function(){return new NodeInjector$1(this._hostTNode,this._hostView)},enumerable:!0,configurable:!0}),Object.defineProperty(ViewContainerRef_.prototype,"parentInjector",{get:function(){var parentLocation=getParentInjectorLocation(this._hostTNode,this._hostView),parentView=getParentInjectorView(parentLocation,this._hostView),parentTNode=function(location,startView,startTNode){if(startTNode.parent&&-1!==startTNode.parent.injectorIndex){for(var injectorIndex=startTNode.parent.injectorIndex,parentTNode_1=startTNode.parent;null!=parentTNode_1.parent&&injectorIndex==parentTNode_1.injectorIndex;)parentTNode_1=parentTNode_1.parent;return parentTNode_1}for(var viewOffset=getParentInjectorViewOffset(location),parentView=startView,parentTNode=startView[HOST_NODE];viewOffset>0;)parentTNode=(parentView=parentView[DECLARATION_VIEW])[HOST_NODE],viewOffset--;return parentTNode}(parentLocation,this._hostView,this._hostTNode);return hasParentInjector(parentLocation)&&null!=parentTNode?new NodeInjector$1(parentTNode,parentView):new NullInjector},enumerable:!0,configurable:!0}),ViewContainerRef_.prototype.clear=function(){for(;this._lContainer[VIEWS].length;)this.remove(0)},ViewContainerRef_.prototype.get=function(index){return this._viewRefs[index]||null},Object.defineProperty(ViewContainerRef_.prototype,"length",{get:function(){return this._lContainer[VIEWS].length},enumerable:!0,configurable:!0}),ViewContainerRef_.prototype.createEmbeddedView=function(templateRef,context,index){var adjustedIdx=this._adjustIndex(index),viewRef=templateRef.createEmbeddedView(context||{},this._lContainer,this._hostTNode,this._hostView,adjustedIdx);return viewRef.attachToViewContainerRef(this),this._viewRefs.splice(adjustedIdx,0,viewRef),viewRef},ViewContainerRef_.prototype.createComponent=function(componentFactory,index,injector,projectableNodes,ngModuleRef){var contextInjector=injector||this.parentInjector;!ngModuleRef&&contextInjector&&(ngModuleRef=contextInjector.get(NgModuleRef,null));var componentRef=componentFactory.create(contextInjector,projectableNodes,void 0,ngModuleRef);return this.insert(componentRef.hostView,index),componentRef},ViewContainerRef_.prototype.insert=function(viewRef,index){if(viewRef.destroyed)throw new Error("Cannot insert a destroyed View in a ViewContainer!");var lView=viewRef._view,adjustedIdx=this._adjustIndex(index);insertView(lView,this._lContainer,this._hostView,adjustedIdx,this._hostTNode.index);var beforeNode=getBeforeNodeForView(adjustedIdx,this._lContainer[VIEWS],this._lContainer[NATIVE]);return addRemoveViewFromContainer(lView,!0,beforeNode),viewRef.attachToViewContainerRef(this),this._viewRefs.splice(adjustedIdx,0,viewRef),viewRef},ViewContainerRef_.prototype.move=function(viewRef,newIndex){var index=this.indexOf(viewRef);return this.detach(index),this.insert(viewRef,this._adjustIndex(newIndex)),viewRef},ViewContainerRef_.prototype.indexOf=function(viewRef){return this._viewRefs.indexOf(viewRef)},ViewContainerRef_.prototype.remove=function(index){var adjustedIdx=this._adjustIndex(index,-1);removeView(this._lContainer,this._hostTNode,adjustedIdx),this._viewRefs.splice(adjustedIdx,1)},ViewContainerRef_.prototype.detach=function(index){var adjustedIdx=this._adjustIndex(index,-1);return detachView(this._lContainer,adjustedIdx,!!this._hostTNode.detached),this._viewRefs.splice(adjustedIdx,1)[0]||null},ViewContainerRef_.prototype._adjustIndex=function(index,shift){return void 0===shift&&(shift=0),null==index?this._lContainer[VIEWS].length+shift:(ngDevMode&&(index<=-1&&throwError("index must be positive"),assertLessThan(index,this._lContainer[VIEWS].length+1+shift,"index")),index)},ViewContainerRef_}(ViewContainerRefToken)),ngDevMode&&assertNodeOfPossibleTypes(hostTNode,0,3,4);var slotValue=hostView[hostTNode.index];if(isLContainer(slotValue))(lContainer=slotValue)[ACTIVE_INDEX]=-1;else{var commentNode=hostView[RENDERER].createComment(ngDevMode?"container":"");if(ngDevMode&&ngDevMode.rendererCreateComment++,isRootView(hostView)){var renderer=hostView[RENDERER],hostNative=getNativeByTNode(hostTNode,hostView),parentOfHostNative=nativeParentNode(renderer,hostNative);nativeInsertBefore(renderer,parentOfHostNative,commentNode,function(renderer,node){return isProceduralRenderer(renderer)?renderer.nextSibling(node):node.nextSibling}(renderer,hostNative))}else appendChild(commentNode,hostTNode,hostView);hostView[hostTNode.index]=lContainer=createLContainer(slotValue,hostTNode,hostView,commentNode,!0),addToViewTree(hostView,hostTNode.index,lContainer)}return new R3ViewContainerRef(lContainer,hostTNode,hostView)}(ViewContainerRefToken,ElementRefToken,getPreviousOrParentTNode(),getViewData())},SWITCH_VIEW_CONTAINER_REF_FACTORY=noop,ChangeDetectorRef=function(){function ChangeDetectorRef(){}return ChangeDetectorRef.__NG_ELEMENT_ID__=function(){return SWITCH_CHANGE_DETECTOR_REF_FACTORY()},ChangeDetectorRef}(),SWITCH_CHANGE_DETECTOR_REF_FACTORY__POST_R3__=function(){return createViewRef(getPreviousOrParentTNode(),getViewData(),null)},SWITCH_CHANGE_DETECTOR_REF_FACTORY=function(){for(var args=[],_i=0;_i<arguments.length;_i++)args[_i]=arguments[_i]},ViewRef$1=function(_super){function ViewRef(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(ViewRef,_super),ViewRef}(ChangeDetectorRef),EmbeddedViewRef=function(_super){function EmbeddedViewRef(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(EmbeddedViewRef,_super),EmbeddedViewRef}(ViewRef$1),EventListener=function(){return function(name,callback){this.name=name,this.callback=callback}}(),DebugNode=function(){function DebugNode(nativeNode,parent,_debugContext){this.nativeNode=nativeNode,this._debugContext=_debugContext,this.listeners=[],this.parent=null,parent&&parent instanceof DebugElement&&parent.addChild(this)}return Object.defineProperty(DebugNode.prototype,"injector",{get:function(){return this._debugContext.injector},enumerable:!0,configurable:!0}),Object.defineProperty(DebugNode.prototype,"componentInstance",{get:function(){return this._debugContext.component},enumerable:!0,configurable:!0}),Object.defineProperty(DebugNode.prototype,"context",{get:function(){return this._debugContext.context},enumerable:!0,configurable:!0}),Object.defineProperty(DebugNode.prototype,"references",{get:function(){return this._debugContext.references},enumerable:!0,configurable:!0}),Object.defineProperty(DebugNode.prototype,"providerTokens",{get:function(){return this._debugContext.providerTokens},enumerable:!0,configurable:!0}),DebugNode}(),DebugElement=function(_super){function DebugElement(nativeNode,parent,_debugContext){var _this=_super.call(this,nativeNode,parent,_debugContext)||this;return _this.properties={},_this.attributes={},_this.classes={},_this.styles={},_this.childNodes=[],_this.nativeElement=nativeNode,_this}return __extends(DebugElement,_super),DebugElement.prototype.addChild=function(child){child&&(this.childNodes.push(child),child.parent=this)},DebugElement.prototype.removeChild=function(child){var childIndex=this.childNodes.indexOf(child);-1!==childIndex&&(child.parent=null,this.childNodes.splice(childIndex,1))},DebugElement.prototype.insertChildrenAfter=function(child,newChildren){var _a,_this=this,siblingIndex=this.childNodes.indexOf(child);-1!==siblingIndex&&((_a=this.childNodes).splice.apply(_a,[siblingIndex+1,0].concat(newChildren)),newChildren.forEach(function(c){c.parent&&c.parent.removeChild(c),c.parent=_this}))},DebugElement.prototype.insertBefore=function(refChild,newChild){var refIndex=this.childNodes.indexOf(refChild);-1===refIndex?this.addChild(newChild):(newChild.parent&&newChild.parent.removeChild(newChild),newChild.parent=this,this.childNodes.splice(refIndex,0,newChild))},DebugElement.prototype.query=function(predicate){return this.queryAll(predicate)[0]||null},DebugElement.prototype.queryAll=function(predicate){var matches=[];return _queryElementChildren(this,predicate,matches),matches},DebugElement.prototype.queryAllNodes=function(predicate){var matches=[];return _queryNodeChildren(this,predicate,matches),matches},Object.defineProperty(DebugElement.prototype,"children",{get:function(){return this.childNodes.filter(function(node){return node instanceof DebugElement})},enumerable:!0,configurable:!0}),DebugElement.prototype.triggerEventHandler=function(eventName,eventObj){this.listeners.forEach(function(listener){listener.name==eventName&&listener.callback(eventObj)})},DebugElement}(DebugNode);function _queryElementChildren(element,predicate,matches){element.childNodes.forEach(function(node){node instanceof DebugElement&&(predicate(node)&&matches.push(node),_queryElementChildren(node,predicate,matches))})}function _queryNodeChildren(parentNode,predicate,matches){parentNode instanceof DebugElement&&parentNode.childNodes.forEach(function(node){predicate(node)&&matches.push(node),node instanceof DebugElement&&_queryNodeChildren(node,predicate,matches)})}var _nativeNodeToDebugNode=new Map;function getDebugNode(nativeNode){return _nativeNodeToDebugNode.get(nativeNode)||null}function indexDebugNode(node){_nativeNodeToDebugNode.set(node.nativeNode,node)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(override){return initServicesIfNeeded(),Services.overrideProvider(override)},exports.ɵNOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR=NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR,exports.ɵdefineNgModule=ɵdefineNgModule,exports.ɵdefineBase=defineBase,exports.ɵdefineComponent=defineComponent,exports.ɵdefineDirective=defineDirective,exports.ɵdefinePipe=definePipe,exports.ɵdetectChanges=detectChanges,exports.ɵrenderComponent=function(componentType,opts){void 0===opts&&(opts={}),ngDevMode&&publishDefaultGlobalUtils(),ngDevMode&&assertComponentType(componentType);var rendererFactory=opts.rendererFactory||domRendererFactory3,sanitizer=opts.sanitizer||null,componentDef=getComponentDef(componentType);componentDef.type!=componentType&&(componentDef.type=componentType);var componentTag=componentDef.selectors[0][0],hostRNode=locateHostElement(rendererFactory,opts.host||componentTag),rootFlags=componentDef.onPush?68:66,rootContext=createRootContext(opts.scheduler,opts.playerHandler),renderer=rendererFactory.createRenderer(hostRNode,componentDef),rootView=createLViewData(renderer,createTView(-1,null,1,0,null,null,null),rootContext,rootFlags);rootView[INJECTOR]=opts.injector||null;var component,oldView=enterView(rootView,null);try{rendererFactory.begin&&rendererFactory.begin(),component=createRootComponent(createRootComponentView(hostRNode,componentDef,rootView,renderer,sanitizer),componentDef,rootView,rootContext,opts.hostFeatures||null),refreshDescendantViews(rootView,null)}finally{leaveView(oldView),rendererFactory.end&&rendererFactory.end()}return component},exports.ɵRender3ComponentFactory=ComponentFactory$$1,exports.ɵRender3ComponentRef=ComponentRef$$1,exports.ɵdirectiveInject=directiveInject,exports.ɵinjectAttribute=injectAttribute,exports.ɵgetFactoryOf=getFactoryOf,exports.ɵgetInheritedFactory=getInheritedFactory,exports.ɵtemplateRefExtractor=templateRefExtractor,exports.ɵProvidersFeature=ProvidersFeature,exports.ɵInheritDefinitionFeature=InheritDefinitionFeature,exports.ɵNgOnChangesFeature=NgOnChangesFeature,exports.ɵRender3NgModuleRef=NgModuleRef$1,exports.ɵmarkDirty=function(component){ngDevMode&&assertDefined(component,"component"),markViewDirty(getComponentViewByInstance(component))},exports.ɵNgModuleFactory=NgModuleFactory$1,exports.ɵNO_CHANGE=NO_CHANGE,exports.ɵcontainer=container,exports.ɵnextContext=nextContext,exports.ɵelementStart=elementStart,exports.ɵnamespaceHTML=namespaceHTML,exports.ɵnamespaceMathML=namespaceMathML,exports.ɵnamespaceSVG=namespaceSVG,exports.ɵelement=element,exports.ɵlistener=listener,exports.ɵtext=text,exports.ɵembeddedViewStart=embeddedViewStart,exports.ɵquery=query,exports.ɵregisterContentQuery=registerContentQuery,exports.ɵprojection=projection,exports.ɵbind=bind,exports.ɵinterpolation1=interpolation1,exports.ɵinterpolation2=interpolation2,exports.ɵinterpolation3=interpolation3,exports.ɵinterpolation4=interpolation4,exports.ɵinterpolation5=interpolation5,exports.ɵinterpolation6=interpolation6,exports.ɵinterpolation7=interpolation7,exports.ɵinterpolation8=interpolation8,exports.ɵinterpolationV=interpolationV,exports.ɵpipeBind1=pipeBind1,exports.ɵpipeBind2=pipeBind2,exports.ɵpipeBind3=pipeBind3,exports.ɵpipeBind4=pipeBind4,exports.ɵpipeBindV=pipeBindV,exports.ɵpureFunction0=pureFunction0,exports.ɵpureFunction1=pureFunction1,exports.ɵpureFunction2=pureFunction2,exports.ɵpureFunction3=pureFunction3,exports.ɵpureFunction4=pureFunction4,exports.ɵpureFunction5=pureFunction5,exports.ɵpureFunction6=pureFunction6,exports.ɵpureFunction7=pureFunction7,exports.ɵpureFunction8=pureFunction8,exports.ɵpureFunctionV=pureFunctionV,exports.ɵgetCurrentView=getCurrentView,exports.ɵrestoreView=restoreView,exports.ɵcontainerRefreshStart=containerRefreshStart,exports.ɵcontainerRefreshEnd=containerRefreshEnd,exports.ɵqueryRefresh=queryRefresh,exports.ɵloadQueryList=loadQueryList,exports.ɵelementEnd=elementEnd,exports.ɵelementProperty=elementProperty,exports.ɵprojectionDef=projectionDef,exports.ɵreference=reference,exports.ɵenableBindings=enableBindings,exports.ɵdisableBindings=disableBindings,exports.ɵelementAttribute=elementAttribute,exports.ɵelementStyling=elementStyling,exports.ɵelementStylingMap=elementStylingMap,exports.ɵelementStyleProp=elementStyleProp,exports.ɵelementStylingApply=elementStylingApply,exports.ɵelementClassProp=elementClassProp,exports.ɵtextBinding=textBinding,exports.ɵtemplate=template,exports.ɵembeddedViewEnd=embeddedViewEnd,exports.ɵstore=store,exports.ɵload=load,exports.ɵpipe=pipe,exports.ɵwhenRendered=function(component){return function(component){var rootContext=getRootView(component)[CONTEXT];return ngDevMode&&assertDefined(rootContext,"rootContext"),rootContext}(component).clean},exports.ɵi18nAttribute=i18nAttribute,exports.ɵi18nExp=i18nExp,exports.ɵi18nStart=i18nStart,exports.ɵi18nEnd=i18nEnd,exports.ɵi18nApply=i18nApply,exports.ɵi18nExpMapping=function(translation,placeholders){for(var staticText=translation.split(i18nTagRegex),i=1;i<staticText.length;i+=2)staticText[i]=placeholders[staticText[i]];return staticText},exports.ɵi18nInterpolation1=function(instructions,v0){if(!bindingUpdated(getViewData()[BINDING_INDEX]++,v0))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)res+=1&i?stringify$1(v0):instructions[i];return res},exports.ɵi18nInterpolation2=function(instructions,v0,v1){var viewData=getViewData(),different=bindingUpdated2(viewData[BINDING_INDEX],v0,v1);if(viewData[BINDING_INDEX]+=2,!different)return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)res+=1&i?stringify$1(1&instructions[i]?v1:v0):instructions[i];return res},exports.ɵi18nInterpolation3=function(instructions,v0,v1,v2){var viewData=getViewData(),different=bindingUpdated3(viewData[BINDING_INDEX],v0,v1,v2);if(viewData[BINDING_INDEX]+=3,!different)return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i];res+=stringify$1(2&idx?v2:1&idx?v1:v0)}else res+=instructions[i];return res},exports.ɵi18nInterpolation4=function(instructions,v0,v1,v2,v3){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);if(viewData[BINDING_INDEX]+=4,!different)return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b1=1&idx;res+=stringify$1(2&idx?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵi18nInterpolation5=function(instructions,v0,v1,v2,v3,v4){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);if(different=bindingUpdated(viewData[BINDING_INDEX]+4,v4)||different,viewData[BINDING_INDEX]+=5,!different)return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b1=1&idx;res+=stringify$1(4&idx?v4:2&idx?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵi18nInterpolation6=function(instructions,v0,v1,v2,v3,v4,v5){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);if(different=bindingUpdated2(viewData[BINDING_INDEX]+4,v4,v5)||different,viewData[BINDING_INDEX]+=6,!different)return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b1=1&idx;res+=stringify$1(4&idx?b1?v5:v4:2&idx?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵi18nInterpolation7=function(instructions,v0,v1,v2,v3,v4,v5,v6){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);if(different=bindingUpdated3(viewData[BINDING_INDEX]+4,v4,v5,v6)||different,viewData[BINDING_INDEX]+=7,!different)return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b2=2&idx,b1=1&idx;res+=stringify$1(4&idx?b2?v6:b1?v5:v4:b2?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵi18nInterpolation8=function(instructions,v0,v1,v2,v3,v4,v5,v6,v7){var viewData=getViewData(),different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);if(different=bindingUpdated4(viewData[BINDING_INDEX]+4,v4,v5,v6,v7)||different,viewData[BINDING_INDEX]+=8,!different)return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b2=2&idx,b1=1&idx;res+=stringify$1(4&idx?b2?b1?v7:v6:b1?v5:v4:b2?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵi18nInterpolationV=function(instructions,values){for(var viewData=getViewData(),different=!1,i=0;i<values.length;i++)bindingUpdated(viewData[BINDING_INDEX]++,values[i])&&(different=!0);if(!different)return NO_CHANGE;var res="";for(i=0;i<instructions.length;i++)res+=1&i?stringify$1(values[instructions[i]]):instructions[i];return res},exports.ɵi18nMapping=function(translation,elements,expressions,templateRoots,lastChildIndex){var translationParts=translation.split(i18nTagRegex),nbTemplates=templateRoots?templateRoots.length+1:1,instructions=new Array(nbTemplates).fill(void 0);return function generateMappingInstructions(tmplIndex,partIndex,translationParts,instructions,elements,expressions,templateRoots,lastChildIndex){var tmplInstructions=[],phVisited=[],openedTagCount=0,maxIndex=0,currentElements=elements&&elements[tmplIndex]?elements[tmplIndex]:null,currentExpressions=expressions&&expressions[tmplIndex]?expressions[tmplIndex]:null;for(instructions[tmplIndex]=tmplInstructions;partIndex<translationParts.length;partIndex++){var value=translationParts[partIndex];if(1&partIndex){var phIndex=void 0;if(currentElements&&void 0!==currentElements[value]){phIndex=currentElements[value];var templateRootIndex=templateRoots?templateRoots.indexOf(value):-1;-1!==templateRootIndex&&templateRootIndex+1!==tmplIndex?tmplInstructions.push(-2147483648|phIndex):(tmplInstructions.push(1073741824|phIndex),openedTagCount++),phVisited.push(value)}else if(currentExpressions&&void 0!==currentExpressions[value])phIndex=currentExpressions[value],tmplInstructions.push(1610612736|phIndex),phVisited.push(value);else if(tmplInstructions.push(-1073741824),tmplIndex>0&&0==--openedTagCount)break;if(void 0!==phIndex&&phIndex>maxIndex&&(maxIndex=phIndex),templateRoots){var newTmplIndex=templateRoots.indexOf(value)+1;0!==newTmplIndex&&newTmplIndex!==tmplIndex&&(partIndex=generateMappingInstructions(newTmplIndex,partIndex,translationParts,instructions,elements,expressions,templateRoots,lastChildIndex))}}else value&&tmplInstructions.push(536870912,value)}if(elements){var tmplElements=elements[tmplIndex];if(tmplElements)for(var phKeys=Object.keys(tmplElements),i=0;i<phKeys.length;i++){var ph=phKeys[i];if(-1===phVisited.indexOf(ph)){var index=tmplElements[ph];tmplInstructions.push(-536870912|index),index>maxIndex&&(maxIndex=index)}}}if(expressions){var tmplExpressions=expressions[tmplIndex];if(tmplExpressions)for(var phKeys=Object.keys(tmplExpressions),i=0;i<phKeys.length;i++){var ph=phKeys[i];if(-1===phVisited.indexOf(ph)){var index=tmplExpressions[ph];ngDevMode&&assertLessThan(index.toString(2).length,28,"Index "+index+" is too big and will overflow"),tmplInstructions.push(-536870912|index),index>maxIndex&&(maxIndex=index)}}}if(0===tmplIndex&&"number"==typeof lastChildIndex)for(var i=maxIndex+1;i<=lastChildIndex;i++)ngDevMode&&assertLessThan(i.toString(2).length,28,"Index "+i+" is too big and will overflow"),tmplInstructions.push(-1610612736|i);return partIndex}(0,0,translationParts,instructions,elements,expressions,templateRoots,lastChildIndex),instructions},exports.ɵWRAP_RENDERER_FACTORY2=WRAP_RENDERER_FACTORY2,exports.ɵsetClassMetadata=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(type,decorators,ctorParameters,propDecorators){var _a,clazz=type;null!==decorators&&(void 0!==clazz.decorators?(_a=clazz.decorators).push.apply(_a,decorators):clazz.decorators=decorators),null!==ctorParameters&&(clazz.ctorParameters=ctorParameters),null!==propDecorators&&(void 0!==clazz.propDecorators?clazz.propDecorators=__assign({},clazz.propDecorators,propDecorators):clazz.propDecorators=propDecorators)},exports.ɵRender3DebugRendererFactory2=Render3DebugRendererFactory2,exports.ɵcompileComponent=compileComponent,exports.ɵcompileDirective=compileDirective,exports.ɵcompileNgModule=compileNgModule,exports.ɵcompileNgModuleDefs=compileNgModuleDefs,exports.ɵpatchComponentDefWithScope=patchComponentDefWithScope,exports.ɵcompilePipe=compilePipe,exports.ɵsanitizeHtml=sanitizeHtml,exports.ɵsanitizeStyle=sanitizeStyle,exports.ɵsanitizeUrl=sanitizeUrl,exports.ɵsanitizeResourceUrl=sanitizeResourceUrl,exports.ɵbypassSanitizationTrustHtml=function(trustedHtml){return bypassSanitizationTrustString(trustedHtml,"Html")},exports.ɵbypassSanitizationTrustStyle=function(trustedStyle){return bypassSanitizationTrustString(trustedStyle,"Style")},exports.ɵbypassSanitizationTrustScript=function(trustedScript){return bypassSanitizationTrustString(trustedScript,"Script")},exports.ɵbypassSanitizationTrustUrl=function(trustedUrl){return bypassSanitizationTrustString(trustedUrl,"Url")},exports.ɵbypassSanitizationTrustResourceUrl=function(trustedResourceUrl){return bypassSanitizationTrustString(trustedResourceUrl,"ResourceUrl")},exports.ɵgetContext=getContext,exports.ɵbindPlayerFactory=function(factoryFn,value){return new BoundPlayerFactory(factoryFn,value)},exports.ɵaddPlayer=function(ref,player){var context=getContext(ref);if(context){var element$$1=context.native,lViewData=context.lViewData,playerContext=function(target,context){if(!(context=context||getContext(target)))return ngDevMode&&throwInvalidRefError(),null;var lViewData=context.lViewData,stylingContext=getStylingContext(context.nodeIndex-HEADER_OFFSET,lViewData);return getPlayerContext(stylingContext)||allocPlayerContext(stylingContext)}(element$$1,context),rootContext=getRootContext$2(lViewData);addPlayerInternal(playerContext,rootContext,element$$1,player,0,ref),scheduleTick(rootContext,2)}else ngDevMode&&throwInvalidRefError()},exports.ɵgetPlayers=function(ref){var context=getContext(ref);if(!context)return ngDevMode&&throwInvalidRefError(),[];var stylingContext=getStylingContext(context.nodeIndex-HEADER_OFFSET,context.lViewData),playerContext=stylingContext?getPlayerContext(stylingContext):null;return playerContext?function(playerContext){for(var players=[],nonFactoryPlayersStart=playerContext[0],i=2;i<nonFactoryPlayersStart;i+=2){var player=playerContext[i];player&&players.push(player)}for(i=nonFactoryPlayersStart;i<playerContext.length;i++)players.push(playerContext[i]);return players}(playerContext):[]},exports.ɵcompileNgModuleFactory__POST_R3__=function(injector,options,moduleType){var msg;return ngDevMode&&(void 0===msg&&(msg="Type passed in is not NgModuleType, it does not have 'ngModuleDef' property."),getNgModuleDef(moduleType)||throwError(msg)),Promise.resolve(new NgModuleFactory$1(moduleType))},exports.ɵSWITCH_COMPILE_COMPONENT__POST_R3__=SWITCH_COMPILE_COMPONENT__POST_R3__,exports.ɵSWITCH_COMPILE_DIRECTIVE__POST_R3__=SWITCH_COMPILE_DIRECTIVE__POST_R3__,exports.ɵSWITCH_COMPILE_PIPE__POST_R3__=SWITCH_COMPILE_PIPE__POST_R3__,exports.ɵSWITCH_COMPILE_NGMODULE__POST_R3__=SWITCH_COMPILE_NGMODULE__POST_R3__,exports.ɵSWITCH_COMPILE_INJECTABLE__POST_R3__=SWITCH_COMPILE_INJECTABLE__POST_R3__,exports.ɵSWITCH_IVY_ENABLED__POST_R3__=!0,exports.ɵSWITCH_CHANGE_DETECTOR_REF_FACTORY__POST_R3__=SWITCH_CHANGE_DETECTOR_REF_FACTORY__POST_R3__,exports.ɵSWITCH_ELEMENT_REF_FACTORY__POST_R3__=SWITCH_ELEMENT_REF_FACTORY__POST_R3__,exports.ɵSWITCH_TEMPLATE_REF_FACTORY__POST_R3__=SWITCH_TEMPLATE_REF_FACTORY__POST_R3__,exports.ɵSWITCH_VIEW_CONTAINER_REF_FACTORY__POST_R3__=SWITCH_VIEW_CONTAINER_REF_FACTORY__POST_R3__,exports.ɵSWITCH_RENDERER2_FACTORY__POST_R3__=SWITCH_RENDERER2_FACTORY__POST_R3__,exports.ɵpublishGlobalUtil=publishGlobalUtil,exports.ɵpublishDefaultGlobalUtils=publishDefaultGlobalUtils,exports.ɵSWITCH_INJECTOR_FACTORY__POST_R3__=function(){return tNode=getPreviousOrParentTNode(),new NodeInjector(tNode,getViewData());var tNode},exports.ɵregisterModuleFactory=function(id,factory){var existing=moduleFactories.get(id);if(existing)throw new Error("Duplicate module registered for "+id+" - "+existing.moduleType.name+" vs "+factory.moduleType.name);moduleFactories.set(id,factory)},exports.ɵEMPTY_ARRAY=[],exports.ɵEMPTY_MAP={},exports.ɵand=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
