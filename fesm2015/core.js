...
function searchTokensOnInjector(injectorIndex, injectorView, token, previousTView) {
    ...
    /** @type {?} */
    const startInjectables = nodeProviderIndexes & 65535;
    /** @type {?} */
    const startDirectives = nodeFlags >> 16;
    /** @type {?} */
    ...
    /** @type {?} */
    const directiveCount = nodeFlags & 4095;
...
function createStylingContextTemplate(initialClassDeclarations, initialStyleDeclarations, styleSanitizer, onlyProcessSingleClasses) {
    ...
    /** @type {?} */
    const maxLength = totalProps * 4 /* Size */ * 2 + 8;
    ...
    const singleStart = 8;
    /** @type {?} */
    const multiStart = totalProps * 4 /* Size */ + 8;
...
function updateStylingMap(context, classesInput, stylesInput) {
    ...
    /** @type {?} */
    const classes = /** @type {?} */ ((classesValue || EMPTY_OBJ$1));
    /** @type {?} */
    const styleProps = stylesValue ? Object.keys(stylesValue) : EMPTY_ARR;
    /** @type {?} */
    const styles = stylesValue || EMPTY_OBJ$1;
    /** @type {?} */
...
function updateStyleProp(context, index, input) {
    /** @type {?} */
    const singleIndex = 8 /* SingleStylesStartPosition */ + index * 4;
    /** @type {?} */
...
function renderStyleAndClassBindings(context, renderer, rootOrView, isFirstRender, classesStore, stylesStore) {
    ...
    if (isContextDirty(context)) {
        /** @type {?} */
        const flushPlayerBuilders = context[3 /* MasterFlagPosition */] & 8;
        /** @type {?} */
        ...
        if (flushPlayerBuilders) {
            /** @type {?} */
            const rootContext = Array.isArray(rootOrView) ? getRootContext$1(rootOrView) : /** @type {?} */ (rootOrView);
            /** @type {?} */
            ...
            for (let i = 1 /* PlayerBuildersStartPosition */; i < playersStartIndex; i += 2 /* PlayerAndPlayerBuildersTupleSize */) {
                ...
                /** @type {?} */
                const playerInsertionIndex = i + 1;
                /** @type {?} */
...
function getMultiOrSingleIndex(flag) {
    /** @type {?} */
    const index = (flag >> (14 /* BitCountSize */ + 5 /* BitCountSize */)) & 16383;
...
function elementStylingApply(index) {
    ...
    if (totalPlayersQueued > 0) {
        /** @type {?} */
        const rootContext = getRootContext$1(viewData);
...
function instantiateAllDirectives(tView, viewData, previousOrParentTNode) {
    /** @type {?} */
    const start = previousOrParentTNode.flags >> 16;
    /** @type {?} */
    const end = start + previousOrParentTNode.flags & 4095;
...
function createViewRef(hostTNode, hostView, context) {
    if (isComponent(hostTNode)) {
        /** @type {?} */
        const componentIndex = hostTNode.flags >> 16;
        /** @type {?} */
...
function getRootComponents(target) {
    return [...getRootContext$2(target).components];
}
/**
...
function resolveProvider$1(provider, tInjectables, lInjectablesBlueprint, isComponent$$1, isViewProvider) {
    ...
    if (Array.isArray(provider)) {
        ...
        const previousOrParentTNode = getPreviousOrParentTNode();
        /** @type {?} */
        const beginIndex = previousOrParentTNode.providerIndexes & 65535;
        /** @type {?} */
        const endIndex = previousOrParentTNode.flags >> 16;
        /** @type {?} */
        const cptViewProvidersCount = previousOrParentTNode.providerIndexes >> 16;
 ...
 * found in the LICENSE file at https://angular.io/license
 */
class ComponentFactoryResolver$$1 extends ComponentFactoryResolver$1 {
    /**
     * @template T
     * @param {?} component
     * @return {?}
 ...
 * @template T
 */
class ComponentFactory$$1 extends ComponentFactory$1 {
    /**
     * @param {?} componentDef
     */
 ...
 * @template T
 */
class ComponentRef$$1 extends ComponentRef$1 {
    /**
     * @param {?} componentType
     * @param {?} instance
     * @param {?} rootView
...
function i18nApply(startIndex, instructions) {
    ...
    for (let i = 0; i < instructions.length; i++) {
        ...
        switch (instruction & -536870912 /* InstructionMask */) {
            ...
            case -1610612736 /* Any */:
                /** @type {?} */
                const nodeIndex = instruction & 536870911;
                localPreviousTNode =
            ...
            case -536870912 /* RemoveNode */:
                ...
                /** @type {?} */
                const removeIndex = instruction & 536870911;
                /** @type {?} */
...
class NgModuleRef_ {
     ...
     * @return {?}
     */
    get componentFactoryResolver() { return this.get(ComponentFactoryResolver$1); }
    /**
     * @return {?}
     */
    destroy() {
...
class Render3DebugContext {
    ...
    get providerTokens() {
        ...
        /** @type {?} */
        const directivesCount = tNode.flags & 4095;
        if (directivesCount > 0) {
            /** @type {?} */
            const directiveIdxStart = tNode.flags >> 16;
            /** @type {?} */
 ...
 */
/** @type {?} */
const ɵdefineNgModule = defineNgModule;
